!function t(e, i, n) {
    ...
    1: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
            this.$changeform = t
        };
        o.prototype = {
            getContentWrappers: function () {
                var t = this.$changeform.find("#content-main > form > div"), e = t.find("> .module"),
                    i = t.find("> .inline-group");
                return n().add(e).add(i)
            }, getHashSelector: function (t) {
                if (void 0 == t) return null;
                var e = t.match(/^(#(\/tab\/(.+)\/)?)?$/i);
                return null == e ? null : void 0 != e[3] ? e[3] : ""
            }, showTab: function (t, e) {
                var i = this.$changeform.find(".changeform-tabs-item"), n = this.getContentWrappers(),
                    o = this.getHashSelector(t);
                if (e || null != o) {
                    null != o && 0 != o.length || (o = this.getHashSelector(i.first().find(".changeform-tabs-item-link").attr("href")));
                    var s = n.filter("." + o),
                        r = i.find('.changeform-tabs-item-link[href="#/tab/' + o + '/"]').closest(".changeform-tabs-item");
                    i.removeClass("selected"), r.addClass("selected"), n.removeClass("selected"), s.addClass("selected")
                }
            }, initTabs: function () {
                var t = this;
                ...
                var t = this.$changeform.find(".changeform-tabs-item"), e = this.getContentWrappers(), i = this;
                t.each(function () {
                    var t = n(this), o = i.getHashSelector(t.find(".changeform-tabs-item-link").attr("href"));
                    if (o) {
                        var s = e.filter("." + o);
                        s.find(".form-row.errors").length && t.addClass("errors")
                    }
                })
            }, run: function () {
                try {
                    this.initTabs(), this.updateErrorState()
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
        }, n(document).ready(function () {
            n(".change-form").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
    2: [function (t, e, i) {
        var n = t("jquery"), o = t("../utils/translate"), s = function (t) {
            this.$changeForm = t
        };
        s.prototype = {
            changeDetected: !1, onWindowBeforeUnload: function () {
                return o("Warning: you have unsaved changes")
            }, onFormInputChanged: function (t) {
                t.off("change", this.onFormInputChanged), self.changeDetected || n(window).bind("beforeunload", this.onWindowBeforeUnload), this.changeDetected = !0
            }, initUnsavedChangesWarning: function (t) {
                var e = this, i = t.find("#content-main form");
                if (0 != i.length) {
                    var o = i.find("input, textarea, select");
                    n(document).on("submit", "form", function () {
                        n(window).off("beforeunload", e.onWindowBeforeUnload)
                    }), o.on("change", n.proxy(this.onFormInputChanged, this, o))
                }
            }, run: function () {
                try {
    ...
    3: [function (t, e, i) {
        ...
        o.prototype = {
            updateFixedHeaderVisibility: function (t, e) {
                var i = n(window).scrollTop() > e.offset().top;
                t.closest("table").toggle(i)
            }, updateFixedHeaderWidth: function (t, e) {
                var i = e.find("th"), o = t.find("th");
                i.each(function (t) {
                    o.eq(t).css("width", n(this).width())
                })
            }, initFixedHeader: function (t) {
                var e = t.find("#result_list thead");
                if (0 != e.length) {
                    var i = e.clone(), o = n("<table>").addClass("helper").append(i);
                    o.find(".action-checkbox-column").empty(), o.appendTo(document.body), n(window).on("scroll", n.proxy(this.updateFixedHeaderVisibility, this, o, e)), n(window).on("resize", n.proxy(this.updateFixedHeaderWidth, this, i, e)), this.updateFixedHeaderWidth(i, e)
                }
            }, updateFixedFooter: function (t, e) {
                if (n(window).scrollTop() + n(window).height() < t.offset().top + t.outerHeight(!1) + e.innerHeight()) {
                    if (!e.hasClass("fixed")) {
                        var i = n(window).scrollTop();
                        e.addClass("fixed"), t.css("margin-bottom", e.innerHeight() + "px"), n(window).scrollTop(i)
                    }
                } else e.hasClass("fixed") && (e.removeClass("fixed"), t.css("margin-bottom", 0))
            }, initFixedFooter: function (t) {
                var e = t.find(".changelist-footer"), i = e.siblings(".results");
                0 != e.length && 0 != i.length && (n(window).on("scroll", n.proxy(this.updateFixedFooter, this, i, e)), n(window).on("resize", n.proxy(this.updateFixedFooter, this, i, e)), this.updateFixedFooter(i, e))
            }, initHeaderSortableSelection: function () {
                n("table thead .sortable").on("click", function (t) {
                    if (t.target == this) {
                        var e = n(this).find(".text a").get(0);
                        void 0 != e && e.click()
                    }
                })
            }, initRowSelection: function (t) {
                t.find("#result_list tbody th, #result_list tbody td").on("click", function (t) {
                    t.target == this && n(this).closest("tr").find(".action-checkbox .action-select").click()
                })
            }, run: function () {
                var t = this.$changelist;
                try {
                    this.initFixedHeader(t), this.initFixedFooter(t), this.initHeaderSortableSelection(t), this.initRowSelection(t)
                } catch (e) {
            ...
            n("#changelist").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
    4: [function (t, e, i) {
        var n = t("jquery"), o = function () {
        };
        o.prototype = {
            uniqueCheckboxIdCounter: 0,
            uniqueCheckboxIdPrefix: "unique_checkbox_id_",
            addLabelToCheckbox: function (t) {
                var e = t.attr("id") ? t.attr("id") : this.uniqueCheckboxIdPrefix + this.uniqueCheckboxIdCounter++;
                t.attr("id", e), n("<label>").attr("for", e).insertAfter(t)
            },
            addLabelToCheckboxes: function () {
                var t = this;
                n('input[type="checkbox"]').each(function () {
                    var e = n(this);
                    void 0 != e.attr("id") && 0 != n('label[for="' + e.attr("id") + '"]').length || t.addLabelToCheckbox(e)
                })
            },
            run: function () {
                try {
    ...
    5: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
            this.$inline = t, this.prefix = t.data("inline-prefix"), this.verboseName = t.data("inline-verbose-name"), this.deleteText = t.data("inline-delete-text")
        };
        o.prototype = {
            updateLabels: function (t) {
                var e = this, i = t.find(".inline-navigation-item");
                t.find(".inline-related").each(function (t) {
                    var o = n(this), s = o.find(".inline_label"), r = s.html().replace(/(#\d+)/g, "#" + (t + 1)),
                        a = i.eq(t), l = o.hasClass("has_original") ? r : e.verboseName + " " + r;
                    s.html(r), a.html(l)
                })
            }, updateFormIndex: function (t, e) {
                var i = new RegExp("(" + this.prefix + "-(\\d+|__prefix__))"), o = this.prefix + "-" + e;
                t.find("*").each(function () {
                    var t = n(this);
                    n.each(["for", "id", "name"], function () {
                        var e = this;
                        t.attr(e) && t.attr(e, t.attr(e).replace(i, o))
                    })
                }), t.hasClass("empty-form") || t.attr("id", this.prefix + "-" + e)
            }, updateFormsIndexes: function (t) {
                var e = this, i = t.find(".inline-navigation-item");
                t.find(".inline-related").each(function (t) {
                    var o = n(this);
                    e.updateFormIndex(o, t), i.eq(t).attr("data-inline-related-id", o.attr("id"))
                })
            }, updateTotalForms: function (t) {
                var e = t.find('[name="' + this.prefix + '-TOTAL_FORMS"]'),
                    i = t.find('[name="' + this.prefix + '-MAX_NUM_FORMS"]'),
                    n = parseInt(t.find(".inline-related").length), o = i.val() ? parseInt(i.val()) : 1 / 0;
                e.val(n), t.find(".add-row").toggle(o >= n)
            }, addNavigationItem: function (t, e) {
                var i = t.find(".inline-navigation-item.empty");
                return i.clone().removeClass("empty").attr("data-inline-related-id", e.attr("id")).insertBefore(i)
            }, openNavigationItem: function (t, e) {
                t.find(".inline-related").removeClass("selected").filter("#" + e.attr("data-inline-related-id")).addClass("selected"), t.find(".inline-navigation-item").removeClass("selected"), e.addClass("selected")
            }, removeItem: function (t, e) {
                e.remove(), t.find('.inline-navigation-item[data-inline-related-id="' + e.attr("id") + '"]').remove()
            }, openFirstNavigationItem: function (t) {
                var e = t.find(".inline-navigation-item:not(.empty)").first();
                void 0 != e && (this.openNavigationItem(t, e), this.scrollNavigationToTop(t))
            }, addItemDeleteButton: function (t) {
                t.children(":first").append('<span><a class="inline-deletelink" href="#">' + this.deleteText + "</a></span>")
            }, scrollNavigationToTop: function (t) {
                var e = t.find(".inline-navigation-content");
                e.stop().animate({scrollTop: 0})
            }, scrollNavigationToBottom: function (t) {
                var e = t.find(".inline-navigation-content");
                e.stop().animate({scrollTop: e.prop("scrollHeight")})
            }, initAdding: function (t) {
                var e = this;
                t.find(".add-row a").on("click", function (i) {
                    i.preventDefault();
                    var n = t.find(".inline-related.empty-form"), o = parseInt(t.find(".inline-related").length) - 1,
                        s = n.clone(!0).removeClass("empty-form").insertBefore(n);
                    e.updateTotalForms(t), e.updateFormIndex(s, o), e.updateFormIndex(n, o + 1);
                    var r = e.addNavigationItem(t, s);
                    e.updateLabels(t), e.openNavigationItem(t, r), e.addItemDeleteButton(s), e.scrollNavigationToBottom(t)
                })
            }, initDeletion: function (t) {
                var e = this;
                t.on("click", ".inline-deletelink", function (i) {
                    i.preventDefault();
                    var o = n(this).closest(".inline-related");
                    e.removeItem(t, o), e.updateFormsIndexes(t), e.updateLabels(t), e.updateTotalForms(t), e.openFirstNavigationItem(t)
                }), t.find(".inline-related").each(function () {
                    var e = n(this);
                    e.find(".delete input").on("change", function () {
                        t.find('.inline-navigation-item[data-inline-related-id="' + e.attr("id") + '"]').toggleClass("delete", n(this).is(":checked"))
                    })
                })
            }, initNavigation: function (t) {
                var e = this;
                t.on("click", ".inline-navigation-item", function (i) {
                    i.preventDefault(), e.openNavigationItem(t, n(this))
                }), e.openFirstNavigationItem(t)
            }, run: function () {
                var t = this.$inline;
                try {
                    this.initAdding(t), this.initDeletion(t), this.initNavigation(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
            }
    ...
    6: [function (t, e, i) {
        t("./../utils/jquery-slidefade");
        var n = t("jquery"), o = t("../utils/translate");
        t("jquery-ui/ui/core"), t("jquery-ui/ui/widget"), t("jquery-ui/ui/mouse"), t("jquery-ui/ui/draggable"), t("jquery-ui/ui/droppable"), t("jquery-ui/ui/sortable"), t("jquery-ui/ui/resizable"), t("jquery-ui/ui/button"), t("jquery-ui/ui/dialog");
        var s = function (t) {
            this.$dashboard = t
        };
        s.prototype = {
            initTools: function (t) {
                t.find(".dashboard-tools-toggle").on("click", function (e) {
                    e.preventDefault(), t.find(".dashboard-tools").toggleClass("visible")
                });
                var e = t.find("#add-dashboard-module-form");
                e.find(".add-dashboard-link").on("click", function (t) {
                    var i = e.find('[name="type"]'), o = e.find('[name="module"] option:selected').data("type");
                    o && (i.val(o), n.ajax({
                        url: e.attr("action"),
                        ...
                        data: e.serialize(),
                        success: function (t) {
                            t.error || (document.location = t.success_url)
                        }
                    })), t.preventDefault()
                }), t.find(".reset-dashboard-link").on("click", function (e) {
                    var i = {}, s = function () {
                        var e = t.find("#reset-dashboard-form");
                        n.ajax({
                            url: e.attr("action"),
                            method: e.attr("method"),
                            dataType: "json",
                    ...
                    i[o("Yes")] = function () {
                        s(), n(this).dialog("close")
                    }, i[o("Cancel")] = function () {
                        n(this).dialog("close")
                    }, t.find("#reset-dashboard-dialog").dialog({
                        resizable: !1,
                        modal: !0,
                        buttons: i
                    }), e.preventDefault()
                })
            }, updateDashboardModules: function (t) {
                var e = t.find("#update-dashboard-modules-form"), i = [];
                t.find(".dashboard-column").each(function () {
                    var t = n(this), e = t.closest(".dashboard-column-wrapper").index();
                    t.find(".dashboard-item").each(function () {
                        var t = n(this), o = t.index(), s = t.data("module-id");
                        i.push({id: s, column: e, order: o})
                    })
                }), e.find('[name="modules"]').val(JSON.stringify(i)), n.ajax({
                    url: e.attr("action"),
                    method: e.attr("method"),
                    dataType: "json",
                    data: e.serialize()
                })
            }, initModulesDragAndDrop: function (t) {
                var e = this;
                t.find(".dashboard-column").droppable({
                    activeClass: "active",
                    hoverClass: "hovered",
                    tolerance: "pointer",
                    ...
                    update: function (i, n) {
                        e.updateDashboardModules(t)
                    }
                })
            }, initCollapsibleModules: function (t) {
                var e = t.find("#update-dashboard-module-collapse-form");
                t.find(".dashboard-item.collapsible").each(function () {
                    var t = n(this), i = t.find(".dashboard-item-collapse"), o = t.find(".dashboard-item-content"),
                        s = t.data("module-id");
                    i.on("click", function (i) {
                        i.preventDefault(), o.slideFadeToggle(200, "swing", function () {
                            var i = 0 == o.is(":visible");
                            i ? t.addClass("collapsed") : t.removeClass("collapsed"), e.find('[name="id"]').val(s), e.find('[name="collapsed"]').val(i ? "true" : "false"), n.ajax({
                                url: e.attr("action"),
                                method: e.attr("method"),
                                dataType: "json",
                                data: e.serialize()
            ...
            }, initDeletableModules: function (t) {
                var e = t.find("#remove-dashboard-module-form");
                t.find(".dashboard-item.deletable").each(function () {
                    var i = n(this), s = i.find(".dashboard-item-remove"), r = i.data("module-id");
                    s.on("click", function (s) {
                        s.preventDefault();
                        var a = {}, l = function () {
                            i.fadeOut(200, "swing", function () {
                                e.find('[name="id"]').val(r), n.ajax({
                                    url: e.attr("action"),
                                    method: e.attr("method"),
                                    dataType: "json",
                                    data: e.serialize()
                        ...
                        a[o("Delete")] = function () {
                            ...
                            n(this).dialog("close")
                        }, t.find("#module-remove-dialog").dialog({resizable: !1, modal: !0, buttons: a})
                    })
                })
            }, initAjaxModules: function (t) {
                t.find(".dashboard-item.ajax").each(function () {
                    var t = n(this), e = t.find(".dashboard-item-content"), i = t.data("ajax-url");
                    n.ajax({
                        url: i, dataType: "json", success: function (t) {
                            if (t.error) return void e.empty();
                            var i = e.height();
                            e.html(t.html);
                            var n = e.height();
                            e.height(i), e.animate({height: n}, 250, "swing", function () {
                                e.height("auto")
                            })
                        }, error: function () {
                            e.empty()
            ...
            }, updateModuleChildrenFormsetLabels: function (t) {
                t.find(".inline-related").each(function (t) {
                    n(this).find(".inline_label").text("#" + (t + 1))
                })
            }, updateModuleChildrenFormsetFormIndex: function (t, e) {
                var i = "children", o = new RegExp("(" + i + "-(\\d+|__prefix__))"), s = i + "-" + e;
                t.find("fieldset.module *").each(function () {
                    var t = n(this);
                    n.each(["for", "id", "name"], function () {
                        var e = this;
                        t.attr(e) && t.attr(e, t.attr(e).replace(o, s))
                    })
                })
            }, updateModuleChildrenFormsetFormsIndexes: function (t) {
                var e = this, i = parseInt(t.find(".inline-related.has_original").length);
                t.find(".inline-related.last-related").each(function (t) {
                    e.updateModuleChildrenFormsetFormIndex(n(this), i + t)
                })
            }, updateModuleChildrenFormsetTotalForms: function (t) {
                var e = t.find('[name="children-TOTAL_FORMS"]'), i = parseInt(t.find(".inline-related").length);
                e.val(i)
            }, initModuleChildrenFormsetUpdate: function (t) {
                if (t.hasClass("change-form")) {
                    var e = this, i = t.find(".inline-group");
                    i.find(".add-row a").on("click", function (t) {
                        t.preventDefault();
                        var n = i.find(".inline-related.empty-form"),
                            o = n.clone(!0).removeClass("empty-form").insertBefore(n);
                        e.updateModuleChildrenFormsetLabels(i), e.updateModuleChildrenFormsetFormIndex(n, parseInt(i.find(".inline-related").length) - 1), e.updateModuleChildrenFormsetFormIndex(o, parseInt(i.find(".inline-related").length) - 2), e.updateModuleChildrenFormsetTotalForms(i)
                    }), i.find(".inline-deletelink").on("click", function (t) {
                        t.preventDefault(), n(this).closest(".inline-related").remove(), e.updateModuleChildrenFormsetFormsIndexes(i), e.updateModuleChildrenFormsetLabels(i), e.updateModuleChildrenFormsetTotalForms(i)
                    })
                }
            }, run: function () {
                var t = this.$dashboard;
                try {
                    this.initTools(t), this.initModulesDragAndDrop(t), this.initCollapsibleModules(t), this.initDeletableModules(t), this.initAjaxModules(t), this.initModuleChildrenFormsetUpdate(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
            ...
            n(".dashboard.jet").each(function () {
                new s(n(this)).run()
            })
        })
    }, {
        "../utils/translate": 37,
        "./../utils/jquery-slidefade": 36,
        jquery: 69,
        "jquery-ui/ui/button": 55,
        "jquery-ui/ui/core": 56,
        "jquery-ui/ui/dialog": 58,
        "jquery-ui/ui/draggable": 59,
        "jquery-ui/ui/droppable": 60,
        "jquery-ui/ui/mouse": 61,
        "jquery-ui/ui/resizable": 63,
        "jquery-ui/ui/sortable": 64,
        "jquery-ui/ui/widget": 66
    }],
    7: [function (t, e, i) {
        var n = t("jquery");
        t("jquery-ui/ui/core"), t("jquery-ui/ui/datepicker"), t("timepicker");
        var o = function () {
        };
        o.prototype = {
            removeInputTextNode: function (t) {
                if (0 != t.length) {
                    var e = t.get(0).previousSibling;
                    3 == e.nodeType && n(e).remove()
                }
            }, updateDatetimeLayout: function () {
                var t = this;
                n(".form-row .datetime").each(function () {
                    var e = n(this), i = e.find(".vDateField"), o = e.find(".vTimeField");
                    t.removeInputTextNode(i), t.removeInputTextNode(o), i.nextAll("br").first().remove()
                }), n(".form-row .vDateField").each(function () {
                    var t = n(this), e = n("<span>").addClass("icon-calendar");
                    n("<a>").attr("href", "#").addClass("vDateField-link").append(e).insertAfter(t)
                }), n(".form-row .vTimeField").each(function () {
                    var t = n(this), e = n("<span>").addClass("icon-clock");
                    n("<a>").attr("href", "#").addClass("vTimeField-link").append(e).insertAfter(t)
                })
            }, djangoDateTimeFormatToJs: function (t) {
                return t.toLowerCase().replace(/%\w/g, function (t) {
                    return t = t.replace(/%/, ""), t + t
                })
            }, initDateWidgets: function (t) {
                t = t || n(document);
                var e = this;
                t.find(".form-row .vDateField").each(function () {
                    var t = n(this), i = t.next(".vDateField-link");
                    t.datepicker({
                        dateFormat: e.djangoDateTimeFormatToJs(DATE_FORMAT),
                        showButtonPanel: !0,
                        nextText: "",
                        prevText: ""
                    }), i.on("click", function (e) {
                        t.datepicker("widget").is(":visible") ? t.datepicker("hide") : t.datepicker("show"), e.preventDefault()
                    })
                });
                var i = n.datepicker._gotoToday;
                n.datepicker._gotoToday = function (t) {
                    i.call(this, t), this._selectDate(t)
                }
            }, initTimeWidgets: function (t) {
                t = t || n(document), t.find(".form-row .vTimeField").each(function () {
                    var t = n(this), e = t.next(".vTimeField-link");
                    t.timepicker({
                        showPeriodLabels: !1,
                        showCloseButton: !0,
                        showNowButton: !0
                    }), e.on("click", function (e) {
                        t.datepicker("widget").is(":visible") ? t.datepicker("hide") : t.timepicker("show"), e.preventDefault()
                    })
                })
            }, run: function () {
                try {
                    this.updateDatetimeLayout(), this.initDateWidgets(), this.initTimeWidgets();
                    var t = this;
                    n(".inline-group").on("inline-group-row:added", function (e, i) {
                        i.find(".hasDatepicker").removeClass("hasDatepicker"), i.find(".hasTimepicker").removeClass("hasTimepicker"), t.initDateWidgets(i), t.initTimeWidgets(i)
                    })
                } catch (e) {
                    console.error(e, e.stack)
                }
    ...
    }, {jquery: 69, "jquery-ui/ui/core": 56, "jquery-ui/ui/datepicker": 57, timepicker: 92}],
    8: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
            this.$toolbar = t
        };
        o.prototype = {
            initFiltersInteraction: function (t) {
                t.find(".changelist-filter-select").each(function () {
                    var t = n(this), e = t.attr("multiple");
                    e && t.data("previous-options", t.find("option:selected")), t.on("change", function () {
                        var t = n(this), i = t.find("option:selected");
                        e && (t.data("previous-options").length < i.length ? i = i.filter(function (e, i) {
                            return 0 == t.data("previous-options").filter(function (t, e) {
                                return e == i
                            }).length
                        }) : t.data("previous-options").length > i.length && (i = t.data("previous-options").filter(function (t, e) {
                            return 0 == i.filter(function (t, i) {
                                return e == i
                            }).length
                        })), t.data("previous-options", t.find("option:selected")));
                        var o = i.data("url"), s = t.data("queryset--lookup");
                        o ? document.location = i.data("url") : s && (document.location = "?" + s + "=" + i.val())
                    })
                })
            }, run: function () {
                try {
            ...
            n("#toolbar").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
    9: [function (t, e, i) {
        var n = t("jquery"), o = t("./compact-inline"), s = function (t) {
            this.$inline = t
        };
        s.prototype = {
            initAddRow: function (t) {
                t.on("click", ".add-row a", function () {
                    var e = t.find(".inline-related:not(.empty-form)").last();
                    t.trigger("inline-group-row:added", [e])
                })
            }, run: function () {
                var t = this.$inline;
                try {
                    t.hasClass("compact") && new o(t).run(), this.initAddRow(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
                t.addClass("initialized")
            ...
            n(".inline-group").each(function () {
                new s(n(this)).run()
            })
        })
    }, {"./compact-inline": 5, jquery: 69}],
    10: [function (t, e, i) {
        var n = t("jquery"), o = t("../utils/window-storage"), s = function () {
            this.windowStorage = new o("relatedWindows")
        };
        s.prototype = {
            updateLinks: function (t) {
                t.find("~ .change-related, ~ .delete-related, ~ .add-another").each(function () {
                    var e = n(this), i = e.data("href-template");
                    if (void 0 != i) {
                        var o = t.val();
                        o ? e.attr("href", i.replace("__fk__", o)) : e.removeAttr("href")
                    }
                })
            }, initLinksForRow: function (t) {
                if (!t.data("related-popups-links-initialized")) {
                    var e = this;
                    t.find("select").each(function () {
                        var t = n(this);
                        e.updateLinks(t), t.find("~ .add-related, ~ .change-related, ~ .delete-related, ~ .add-another").each(function () {
                            var i = n(this);
                            i.on("click", function (n) {
                                n.preventDefault();
                                var o = i.attr("href");
                                void 0 != o && (o.indexOf("_popup") == -1 && (o += o.indexOf("?") == -1 ? "?_popup=1" : "&_popup=1"), e.showPopup(t, o))
                            })
                        })
                    }).on("change", function () {
                        e.updateLinks(n(this))
                    }), t.find("input").each(function () {
                        var t = n(this);
                        t.find("~ .related-lookup").each(function () {
                            var i = n(this);
                            i.on("click", function (n) {
                                n.preventDefault();
                                var o = i.attr("href");
                                o += o.indexOf("?") == -1 ? "?_popup=1" : "&_popup=1", e.showPopup(t, o)
                            })
                        })
                    }), t.data("related-popups-links-initialized", !0)
                }
            }, initLinks: function () {
                var t = this;
                n(".form-row").each(function () {
                ...
                var t = this;
                n(".related-popup-back").on("click", function (e) {
                    e.preventDefault(), t.closePopup()
                })
            }, showPopup: function (t, e) {
                var i = n(window.top.document), o = i.find(".related-popup-container"),
                    s = o.find(".loading-indicator"), r = i.find("body"),
                    a = n("<div>").addClass("related-popup").data("input", t),
                    l = n("<iframe>").attr("src", e).on("load", function () {
                        a.add(i.find(".related-popup-back")).fadeIn(200, "swing", function () {
                            s.hide()
                        })
                    });
                a.append(l), s.show(), i.find(".related-popup").add(i.find(".related-popup-back")).fadeOut(200, "swing"), o.fadeIn(200, "swing", function () {
                    o.append(a)
                }), r.addClass("non-scrollable")
            }, closePopup: function (t) {
                var e = this.windowStorage.previous(), i = this;
                !function (e) {
                    var n = e(window.top.document), o = n.find(".related-popup"),
                        s = n.find(".related-popup-container"), r = o.last();
                    void 0 != t && i.processPopupResponse(r, t), i.windowStorage.pop(), 1 == o.length ? s.fadeOut(200, "swing", function () {
                        n.find(".related-popup-back").hide(), n.find("body").removeClass("non-scrollable"), r.remove()
                    }) : o.length > 1 && (r.remove(), o.eq(o.length - 2).show())
                }(e ? e.jet.jQuery : n)
            }, findPopupResponse: function () {
                var t = this;
                n("#django-admin-popup-response-constants").each(function () {
                    var e = n(this), i = e.data("popup-response");
                    t.closePopup(i)
                })
            }, processPopupResponse: function (t, e) {
                var i = t.data("input");
                switch (e.action) {
                    case"change":
                        i.find("option").each(function () {
                            var t = n(this);
                            t.val() == e.value && t.html(e.obj).val(e.new_value)
                        }), i.trigger("change").trigger("select:init");
                        break;
                    case"delete":
                        i.find("option").each(function () {
                            var t = n(this);
                            t.val() == e.value && t.remove()
                        }), i.trigger("change").trigger("select:init");
                        break;
                    default:
                        if (i.is("select")) {
                            var o = n("<option>").val(e.value).html(e.obj);
                            i.append(o), o.attr("selected", !0), i.trigger("change").trigger("select:init")
                        } else i.is("input.vManyToManyRawIdAdminField") && i.val() ? i.val(i.val() + "," + e.value) : i.is("input") && i.val(e.value)
                }
            }, overrideRelatedGlobals: function () {
                var t = this;
                window.showRelatedObjectLookupPopup = window.showAddAnotherPopup = window.showRelatedObjectPopup = function () {
                }, window.opener = this.windowStorage.previous() || window.opener, window.dismissRelatedLookupPopup = function (e, i) {
                    t.closePopup({action: "lookup", value: i})
                }
            }, initDeleteRelatedCancellation: function () {
                var t = this;
                n(".popup.delete-confirmation .cancel-link").on("click", function (e) {
                    e.preventDefault(), t.closePopup()
                }).removeAttr("onclick")
            }, initLookupLinks: function () {
                var t = this;
                n("a[data-popup-opener]").click(function (e) {
                    e.preventDefault(), t.closePopup({action: "lookup", value: n(this).data("popup-opener")})
                })
            }, run: function () {
                this.windowStorage.push(window);
                try {
                    this.initLinks(), this.initPopupBackButton(), this.findPopupResponse(), this.overrideRelatedGlobals(), this.initDeleteRelatedCancellation(), this.initLookupLinks()
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
    ...
    }, {"../utils/window-storage": 38, jquery: 69}],
    11: [function (t, e, i) {
        var n = t("jquery"), o = function () {
        };
        o.prototype = {
            prevScrollTop: null, initDetector: function () {
                var t = this;
                n(window).on("scroll", function () {
                    null != t.prevScrollTop && n(window).scrollTop() > t.prevScrollTop && n(window).scrollTop() > 60 ? n(document.body).addClass("scroll-to-bottom") : n(document.body).removeClass("scroll-to-bottom"), t.prevScrollTop = n(window).scrollTop()
                })
            }, run: function () {
                try {
                    this.initDetector()
    ...
    12: [function (t, e, i) {
        t("select2");
        var n = t("jquery"), o = t("../utils/translate"), s = function () {
        };
        s.prototype = {
            updateAttachBody: function (t) {
                t.prototype._positionDropdown = function () {
                    var t = n(window), e = this.$dropdown.hasClass("select2-dropdown--above"),
                    ...
                    var a = {height: this.$dropdown.outerHeight(!1)},
                        ...
                        u = l.bottom > s.bottom + a.height, d = {left: s.left, top: r.bottom};
                    if (e || i || (o = "below"), u || !c || e ? !c && u && e && (o = "below") : o = "above", ("above" == o || e && "below" !== o) && (d.top = r.top - a.height), null != o) {
                        this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--" + o), this.$container.removeClass("select2-container--below select2-container--above").addClass("select2-container--" + o);
                        var h = this.$dropdown.find(".select2-search");
                        "above" == o && h.is(":first-child") ? h.detach().appendTo(this.$dropdown) : "below" == o && h.is(":last-child") && h.detach().prependTo(this.$dropdown)
                    }
                    this.$dropdownContainer.css(d)
                }, t.prototype.render = function (t) {
                    var e = n("<span></span>"), i = t.call(this);
                    return e.append(i), this.$dropdownContainer = e, this.$element.prop("multiple") ? this.$dropdown.addClass("select2-multiple-dropdown") : this.$dropdown.removeClass("select2-multiple-dropdown"), e
                }
            }, updateDropdownAdapter: function (t) {
                t.prototype.render = function () {
                    var t = "";
                    this.options.get("multiple") && (t = '<div class="select2-buttons"><a href="#" class="select2-buttons-button select2-buttons-button-select-all">' + o("select all") + '</a> <a href="#" class="select2-buttons-button select2-buttons-button-deselect-all">' + o("deselect all") + "</a></div>");
                    var e = n('<span class="select2-dropdown">' + t + '<span class="select2-results"></span></span>'),
                        i = this.$element;
                    return e.find(".select2-buttons-button-select-all").on("click", function (t) {
                        t.preventDefault();
                        var e = [];
                        i.find("option").each(function () {
                            e.push(n(this).val())
                        }), i.select2("val", e), i.select2("close")
                    }), e.find(".select2-buttons-button-deselect-all").on("click", function (t) {
                        t.preventDefault(), i.select2("val", ""), i.select2("close")
                    }), e.attr("dir", this.options.get("dir")), this.$dropdown = e, e
                }
            }, initSelect: function (t, e) {
                var i = {theme: "jet", dropdownAdapter: e, width: "auto"};
                if (t.hasClass("ajax")) {
                    var n = t.data("content-type-id"), o = t.data("app-label"), s = t.data("model"),
                        r = t.data("object-id"), a = 100;
                    i.ajax = {
                        dataType: "json", data: function (t) {
                            return {
                                content_type: n,
                                app_label: o,
                                model: s,
                            ...
                            return {results: t.items, pagination: {more: i}}
                        }
                    }
                }
                t.on("change", function (e) {
                    django.jQuery(t.get(0)).trigger(e)
                }), t.select2(i)
            }, initSelect2: function () {
                var t = this, e = n.fn.select2.amd.require("select2/dropdown/attachBody"),
                    i = n.fn.select2.amd.require("select2/dropdown"), o = n.fn.select2.amd.require("select2/utils"),
                    s = n.fn.select2.amd.require("select2/dropdown/search"),
                    r = n.fn.select2.amd.require("select2/dropdown/minimumResultsForSearch"),
                    a = n.fn.select2.amd.require("select2/dropdown/closeOnSelect");
                this.updateAttachBody(e), this.updateDropdownAdapter(i), i = o.Decorate(i, s), i = o.Decorate(i, e), i = o.Decorate(i, r), i = o.Decorate(i, a), n(document).on("select:init", "select", function () {
                    var e = n(this);
                    e.parents(".empty-form").length > 0 || t.initSelect(e, i)
                }), n("select").trigger("select:init"), n(".inline-group").on("inline-group-row:added", function (t, e) {
                    e.find("select").trigger("select:init")
                })
            }, run: function () {
                try {
                    this.initSelect2()
    ...
    }, {"../utils/translate": 37, jquery: 69, select2: 91}],
    13: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
            this.$siblings = t
        };
        o.prototype = {
            moveSiblings: function (t) {
                t.detach().insertBefore(n(".object-tools"))
            }, run: function () {
                try {
            ...
            n(".changeform-navigation").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
    14: [function (t, e, i) {
        t("./../../utils/jquery-slidefade");
        var n = t("jquery");
        t("jquery-ui/ui/core"), t("jquery-ui/ui/widget"), t("jquery-ui/ui/mouse"), t("jquery-ui/ui/draggable"), t("jquery-ui/ui/resizable"), t("jquery-ui/ui/button"), t("jquery-ui/ui/dialog");
        var o = function (t) {
            this.$sidebar = t
        };
        o.prototype = {
            pinToggle: function (t, e, i) {
                var o = this, s = e.find(".apps-list"), r = e.find(".apps-list-pinned");
                n.ajax({
                    url: t.attr("action"),
                    ...
                    success: function (t) {
                        if (!t.error) {
                            var n = t.pinned ? r : s;
                            i.toggleClass("pinned", t.pinned).detach().appendTo(n), o.updateAppsHide(e)
                        }
                    }
                })
            }, initApplicationPinning: function (t) {
                var e = this;
                t.find(".pin-toggle").on("click", function (i) {
                    i.preventDefault(), i.stopPropagation();
                    var o = n(this).closest(".app-item"), s = o.data("app-label"),
                        r = t.find("#toggle-application-pin-form");
                    r.find('input[name="app_label"]').val(s), e.pinToggle(r, t, o)
                }), t.find(".edit-apps-list").on("click", function (t) {
                    t.preventDefault(), n(this).parents(".sidebar-section").toggleClass("editing")
                })
            }, updateAppsHide: function (t) {
                var e = t.find(".apps-list"), i = t.find(".apps-list-pinned"), n = t.find(".apps-hide");
                0 != e.children().length && 0 != i.children().length || !e.is(":visible") ? (n.toggleClass("apps-visible", e.is(":visible")), n.toggleClass("apps-hidden", !e.is(":visible"))) : n.removeClass("apps-visible apps-hidden")
            }, initAppsHide: function (t) {
                var e = this, i = t.find(".apps-list"), n = t.find(".apps-list-pinned"), o = t.find(".apps-hide");
                o.on("click", function (n) {
                    n.preventDefault(), i.slideFadeToggle(200, "swing", function () {
                        localStorage.side_menu_apps_list_visible = i.is(":visible"), e.updateAppsHide(t)
                    })
                }), "false" === localStorage.side_menu_apps_list_visible && (0 != n.children().length ? i.hide() : localStorage.side_menu_apps_list_visible = !0), this.updateAppsHide(t)
            }, run: function () {
                try {
                    this.initApplicationPinning(this.$sidebar), this.initAppsHide(this.$sidebar)
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
        ...
        s.prototype = {
            addBookmark: function (t, e) {
                n.ajax({
                    ...
                    success: function (t) {
                        if (!t.error) {
                            var i = e.find(".bookmark-item.clone").clone().removeClass("clone");
                            i.attr("href", t.url).find(".sidebar-link-label").append(t.title), i.find(".bookmarks-remove").data("bookmark-id", t.id), e.append(i)
                        }
                    }
                })
            }, deleteBookmark: function (t, e) {
                n.ajax({
                    url: t.attr("action"),
                    method: t.attr("method"),
                    dataType: "json",
            ...
            }, initBookmarksAdding: function (t) {
                var e = this, i = t.find("#bookmarks-add-form"), s = i.find('input[name="title"]'),
                    r = i.find('input[name="url"]'), a = t.find("#bookmarks-add-dialog"), l = t.find(".bookmarks-list");
                t.find(".bookmarks-add").on("click", function (t) {
                    t.preventDefault();
                    var c = n(this), u = c.data("title") ? c.data("title") : document.title, d = window.location.href;
                    s.val(u), r.val(d);
                    var h = {};
                    h[o("Add")] = function () {
                        e.addBookmark(i, l), n(this).dialog("close")
                    }, h[o("Cancel")] = function () {
                        n(this).dialog("close")
                    }, a.dialog({resizable: !1, modal: !0, buttons: h})
                })
            }, initBookmarksRemoving: function (t) {
                var e = this, i = t.find("#bookmarks-remove-form"), s = i.find('input[name="id"]'),
                    r = t.find("#bookmarks-remove-dialog");
                t.on("click", ".bookmarks-remove", function (t) {
                    t.preventDefault();
                    var a = n(this), l = a.closest(".bookmark-item"), c = a.data("bookmark-id");
                    s.val(c);
                    var u = {};
                    u[o("Delete")] = function () {
                        e.deleteBookmark(i, l), n(this).dialog("close")
                    }, u[o("Cancel")] = function () {
                        n(this).dialog("close")
                    }, r.dialog({resizable: !1, modal: !0, buttons: u})
                })
            }, initBookmarks: function (t) {
                this.initBookmarksAdding(t), this.initBookmarksRemoving(t)
            }, run: function () {
                try {
                    this.initBookmarksAdding(this.$sidebar), this.initBookmarksRemoving(this.$sidebar)
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
    ...
    16: [function (t, e, i) {
        var n = t("jquery"), o = t("./application-pinning"), s = t("./bookmarks"), r = t("./popup");
        t("perfect-scrollbar/jquery")(n), t("browsernizr/test/touchevents"), t("browsernizr"), t("jquery.cookie");
        var a = function (t) {
            this.$sidebar = t
        };
        a.prototype = {
            initScrollBars: function (t) {
                n(document.documentElement).hasClass("touchevents") || t.find(".sidebar-wrapper").perfectScrollbar()
            }, initSideBarToggle: function () {
                var t = function (t) {
                    t.preventDefault(), this.sideBarToggle()
                };
                n(".sidebar-toggle").on("click", t.bind(this)), n(document.body).on("click", ".sidebar-backdrop", t.bind(this))
            }, sideBarToggle: function () {
                var t = n(".sidebar-dependent"),
                    e = !t.hasClass("sidebar-opened") && !n(document.body).hasClass("menu-pinned");
                n(document.body).toggleClass("non-scrollable", e).removeClass("menu-pinned"), t.toggleClass("sidebar-opened", e), this.storePinStatus(!1), this.toggleBackdrop(e)
            }, toggleBackdrop: function (t) {
                if (t) {
                    var e = n("<div/>", {"class": "sidebar-backdrop"});
                    n(document.body).append(e), e.animate({opacity: .5}, 300)
                } else n(".sidebar-backdrop").animate({opacity: 0}, 300, function () {
                    n(this).remove()
                })
            }, initPinSideBar: function (t) {
                t.on("click", ".sidebar-pin", function () {
                    var t = n(".sidebar-dependent");
                    n(document.body).hasClass("menu-pinned") ? (t.removeClass("sidebar-opened"), n(document.body).removeClass("menu-pinned"), this.storePinStatus(!1)) : (this.storePinStatus(!0), n(document.body).addClass("menu-pinned").removeClass("non-scrollable")), this.toggleBackdrop(!1), setTimeout(function () {
                        n(window).trigger("resize")
                    }, 500)
                }.bind(this))
            }, storePinStatus: function (t) {
                n.cookie("sidebar_pinned", t, {expires: 365, path: "/"})
            }, addToggleButton: function () {
                var t = n("<span>").addClass("sidebar-container-toggle sidebar-header-menu-icon icon-menu sidebar-toggle");
                n("#container").prepend(t)
            }, run: function () {
                var t = this.$sidebar;
                new o(t).run(), new s(t).run(), new r(t).run();
                try {
                    this.initScrollBars(t), this.addToggleButton(), this.initSideBarToggle(), this.initPinSideBar(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
                t.addClass("initialized")
            ...
            n(".sidebar").each(function () {
                new a(n(this)).run()
            })
        }), e.exports = new a
    }, {
        "./application-pinning": 14,
        "./bookmarks": 15,
        "./popup": 17,
        browsernizr: 39,
        "browsernizr/test/touchevents": 54,
        jquery: 69,
        "jquery.cookie": 67,
        "perfect-scrollbar/jquery": 70
    }],
    17: [function (t, e, i) {
        t("../../utils/jquery-icontains");
        var n = t("jquery");
        t("browsernizr/test/touchevents"), t("browsernizr");
        var o = function (t) {
            this.$sidebar = t
        };
        o.prototype = {
            ...
            resetPopupDisplayTimeout: function () {
                null != this.popupDisplayTimeout && clearTimeout(this.popupDisplayTimeout)
            },
            setCurrentSectionLink: function (t) {
                this.$currentSectionLink && this.$currentSectionLink.removeClass("selected"), this.$currentSectionLink = t, this.$currentSectionLink && this.$currentSectionLink.addClass("selected")
            },
            openPopup: function (t, e) {
                var i = this;
                this.resetPopupDisplayTimeout(), e = e && void 0 != e ? e : 200, this.popupDisplayTimeout = setTimeout(function () {
                    i.popupDisplayTimeout = null;
                    var e = t.find(".sidebar-popup-section");
                    if (e.hide(), i.$currentSectionLink) {
                        var o = e.filter("." + i.$currentSectionLink.data("popup-section-class")),
                            s = o.find(".sidebar-popup-search");
                        o.show(), s.val("").trigger("change").focus(), i.$currentSection = o, i.resetCurrentSectionListItems(), i.$currentSectionListItem = null
                    }
                    t.stop().fadeIn(200, "swing"), n(document.body).addClass("non-scrollable")
                }, e)
            },
            closePopup: function (t, e) {
                var i = this;
                this.resetPopupDisplayTimeout(), e = e && void 0 != e ? e : 50, this.popupDisplayTimeout = setTimeout(function () {
                    i.popupDisplayTimeout = null, i.setCurrentSectionLink(null), i.$currentSection = null, t.stop().fadeOut(200, "swing"), n(document.documentElement).hasClass("touchevents") || n(document.body).removeClass("non-scrollable")
                }, e)
            },
            onSectionLinkInteracted: function (t, e) {
                var i = this.$currentSectionLink && e !== this.$currentSectionLink;
                this.setCurrentSectionLink(e), this.openPopup(t, i ? 500 : null)
            },
            initSectionsDisplay: function (t) {
                var e = this, i = t.find(".sidebar-popup-container"), o = t.find(".sidebar-popup");
                t.find(".popup-section-link").on("mouseenter", function () {
                    n(document.documentElement).hasClass("touchevents") || e.onSectionLinkInteracted(i, n(this))
                }).on("mouseleave", function () {
                    e.closePopup(i)
                }).on("click", function (t) {
                    t.preventDefault(), !n(document.documentElement).hasClass("touchevents") && n(this).attr("href") ? document.location = n(this).attr("href") : e.onSectionLinkInteracted(i, n(this))
                }), t.find(".sidebar-back").on("click touchend", function (t) {
                    t.preventDefault(), e.closePopup(i)
            ...
            initSectionsSearch: function (t) {
                t.find(".sidebar-popup-section").each(function () {
                    var t = n(this), e = t.find(".sidebar-popup-search"), i = t.find(".sidebar-popup-list-item");
                    e.on("change keyup", function () {
                        var t = n(this).val();
                        i.hide().find('.sidebar-popup-list-item-link:icontains("' + t + '")').closest(".sidebar-popup-list-item").show()
                    })
                })
            },
            ...
            moveSectionListItemSelection: function (t) {
                if (null != this.$currentSectionListItem && (t ? this.$currentSectionListItem = this.$currentSectionListItem.nextAll(":visible").first() : this.$currentSectionListItem = this.$currentSectionListItem.prevAll(":visible").first()), null == this.$currentSectionListItem || 0 == this.$currentSectionListItem.length) {
                    var e = this.$currentSection.find(".sidebar-popup-list-item:visible");
                    this.$currentSectionListItem = t ? e.first() : e.last()
                }
                this.resetCurrentSectionListItems(), this.$currentSectionListItem.addClass("selected")
            },
            initSectionKeyboardControls: function () {
                var t = this;
                n(document).keydown(function (e) {
                    if (null != t.$currentSectionLink) {
                        if (38 == e.which) t.moveSectionListItemSelection(!1); else if (40 == e.which) t.moveSectionListItemSelection(!0); else {
                            if (13 != e.which) return;
                            if (t.$currentSectionListItem) {
                                var i = t.$currentSectionListItem.find("a");
                                i.attr("href") && (document.location = i.attr("href"))
                            }
                        }
                        e.preventDefault()
                    }
            ...
            initSectionLists: function (t) {
                var e = this;
                t.find(".sidebar-popup-list-item-link").on("mouseenter", function () {
                    e.$currentSectionListItem = n(this).closest(".sidebar-popup-list-item"), e.resetCurrentSectionListItems(), e.$currentSectionListItem.addClass("selected")
                }).on("touchmove touchend", function (t) {
                    var e = n(this);
                    return "touchmove" == t.type ? void e.data("element_swiped", !0) : ("touchend" == t.type && !e.data("element_swiped") && e.attr("href") && (window.location = e.attr("href")), void e.data("element_swiped", !1))
                }), this.initSectionKeyboardControls()
            },
            run: function () {
                try {
                    this.initSectionsDisplay(this.$sidebar), this.initSectionsSearch(this.$sidebar), this.initSectionLists(this.$sidebar)
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
        }, e.exports = o
    }, {"../../utils/jquery-icontains": 35, browsernizr: 39, "browsernizr/test/touchevents": 54, jquery: 69}],
    18: [function (t, e, i) {
        t("jquery.cookie");
        var n = t("jquery"), o = function () {
        };
        o.prototype = {
            moveChooser: function (t) {
                t.detach().insertAfter(n(".user-tools-welcome-msg")).addClass("initialized")
            }, initChooser: function (t) {
                var e = t.find(".choose-theme");
                e.on("click", function (t) {
                    t.preventDefault();
                    var i = n(this);
                    n.cookie("JET_THEME", i.data("theme"), {expires: 365, path: "/"});
                    var o = [{
                        url: i.data("base-stylesheet"),
                        "class": "base-stylesheet"
                    }, {
                        url: i.data("select2-stylesheet"),
                        "class": "select2-stylesheet"
                    }, {url: i.data("jquery-ui-stylesheet"), "class": "jquery-ui-stylesheet"}], s = 0, r = function () {
                        ++s, s == o.length && n(document).trigger("theme:changed")
                    };
                    n.each(o, function () {
                        n("<link>").attr("rel", "stylesheet").addClass(this["class"]).attr("href", this.url).load(r).appendTo("head"), n("." + this["class"]).slice(0, -2).remove()
                    }), e.removeClass("selected"), i.addClass("selected")
                })
            }, run: function () {
                var t = n(".theme-chooser");
                try {
                    this.moveChooser(t), this.initChooser(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
            }
    ...
    }, {jquery: 69, "jquery.cookie": 67}],
    19: [function (t, e, i) {
        var n = t("jquery");
        t("jquery-ui/ui/core"), t("jquery-ui/ui/position"), t("jquery-ui/ui/widget"), t("jquery-ui/ui/tooltip"), t("browsernizr/test/touchevents"), t("browsernizr");
        var o = function () {
        };
        o.prototype = {
            initTooltips: function () {
                n(document.documentElement).hasClass("touchevents") || n("a[title], .tooltip[title]").tooltip({track: !0})
            }, run: function () {
                try {
                    this.initTooltips()
                } catch (t) {
        ...
        jquery: 69,
        "jquery-ui/ui/core": 56,
        "jquery-ui/ui/position": 62,
        "jquery-ui/ui/tooltip": 65,
        "jquery-ui/ui/widget": 66
    }],
    20: [function (t, e, i) {
        var n = t("jquery"), o = function () {
        ...
        o.prototype = {
            initTouchMoveHandler: function () {
                n(document).on("touchmove", function (t) {
                    for (var e = !0, i = n(t.target); i.length > 0;) {
                        if (i.hasClass("non-scrollable")) {
                            e = !1;
                            break
                        }
                        if (i.hasClass("scrollable") || i.hasClass("ui-widget-overlay")) break;
                        i = i.parent()
                    }
                    e || t.preventDefault()
                })
    ...
    21: [function (t, e, i) {
        ...
        o.prototype = {
            removeLabel: function (t) {
                var e = t.find('[name="action"]').first();
                if (0 != e.length) {
                    var i = n(e[0].previousSibling);
                    3 == i.get(0).nodeType && i.remove()
                }
            }, wrapLabels: function (t) {
                var e = n("<div>").addClass("labels");
                t.find("span.all, span.action-counter, span.clear, span.question").wrapAll(e)
            }, moveActions: function (t) {
                var e = this.$changelist.find(".paginator"), i = n("<div>").addClass("changelist-footer");
                i.insertAfter(e), t.detach(), e.detach(), i.append(t).append(e).append(n("<div>").addClass("cf"))
            }, run: function () {
                var t = this.$changelist.find(".actions");
                try {
                    this.removeLabel(t), this.wrapLabels(t), this.moveActions(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
                t.addClass("initialized")
    ...
    22: [function (t, e, i) {
        ...
        o.prototype = {
            move: function (t) {
                t.detach().prependTo(n(".sidebar-wrapper")).css("height", t.outerHeight())
            }, run: function () {
                var t = this.$branding;
                try {
                    this.move(t)
            ...
            n("#branding").each(function () {
                new o(n(this)).run()
            }), 0 != n("body.login").length && n("<img>").attr("src", "//jet.geex-arts.com/ping.gif")
        })
    }, {jquery: 69}],
    23: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
        ...
        o.prototype = {
            replaceSeparators: function (t) {
                var e = t.html();
                e = e.replace(/›/g, '<span class="icon-arrow-right breadcrumbs-separator"></span>'), t.html(e)
            }, scrollToEnd: function (t) {
                t.scrollLeft(t[0].scrollWidth - t.width())
            }, run: function () {
                var t = this.$breadcrumbs;
                try {
                    this.replaceSeparators(t), this.scrollToEnd(t)
                } catch (e) {
                    console.error(e, e.stack)
                }
                t.addClass("initialized")
    ...
    24: [function (t, e, i) {
        ...
        s.prototype = {
            findTabs: function (t, e) {
                var i = [];
                return t.each(function (t) {
                    var e = n(this), s = e.find("> h2").first(), r = 0 != s.length ? s.html() : o("General"),
                        a = "module_" + t;
                    e.addClass(a), s.remove(), i.push({className: a, title: r})
                }), e.each(function (t) {
                    var e = n(this),
                        s = e.find("> h2, > fieldset.module > h2, .tabular.inline-related > .module > h2").first(),
                        r = 0 != s.length ? s.html() : o("General"), a = "inline_" + t;
                    e.addClass(a), s.remove(), i.push({className: a, title: r})
                }), i
            }, createTabs: function (t, e) {
                if (!(e.length < 2)) {
                    var i = n("<ul>").addClass("changeform-tabs");
                    n.each(e, function () {
                        var t = this, e = n("<li>").addClass("changeform-tabs-item"),
                            o = n("<a>").addClass("changeform-tabs-item-link").html(t.title).attr("href", "#/tab/" + t.className + "/");
                        o.appendTo(e), e.appendTo(i)
                    }), i.insertBefore(t.first())
                }
            }, run: function () {
                var t = this.$changeform.find("#content-main > form > div"), e = t.find("> .module"),
                    i = t.find("> .inline-group"), o = n().add(e).add(i);
                try {
                    var s = this.findTabs(e, i);
                    this.createTabs(o, s)
                } catch (r) {
    ...
    25: [function (t, e, i) {
        ...
        o.prototype = {
            run: function () {
                try {
                    0 != n(".delete-confirmation-marker").length && n("body").addClass("delete-confirmation")
                } catch (t) {
                    console.error(t, t.stack)
                }
            }
    ...
    26: [function (t, e, i) {
        ...
        o.prototype = {
            updateBooleanIcons: function () {
                n('img[src$="admin/img/icon-yes.gif"]').add('img[src$="admin/img/icon-yes.svg"]').after(n('<span class="icon-tick">')), n('img[src$="admin/img/icon-no.gif"]').add('img[src$="admin/img/icon-no.svg"]').after(n('<span class="icon-cross">')), n('img[src$="admin/img/icon-unknown.gif"]').add('img[src$="admin/img/icon-unknown.svg"]').after(n('<span class="icon-question">'))
            }, run: function () {
                try {
        ...
        o.prototype = {
            removeSpacesBetweenPages: function () {
                this.$paginator.contents().each(function () {
                    if (3 == this.nodeType) {
                        var t = n(this);
                        "A" != t.prev().prop("tagName") && "SPAN" != t.prev().prop("tagName") || "A" != t.next().prop("tagName") && "SPAN" != t.next().prop("tagName") || ("..." == n.trim(t.text()) ? t.wrap(n("<span>").addClass("disabled")) : "" == n.trim(t.text()) && t.remove())
                    }
                })
            }, wrapPages: function () {
                var t = !1, e = !1, i = n([]);
                this.$paginator.contents().each(function () {
                    var o = n(this), s = "A" == this.tagName && !o.hasClass("showall") || "SPAN" == this.tagName;
                    s && (t = !0), t && (s && !e ? (o.detach(), i = i.add(o)) : e = !0)
                }), this.$paginator.prepend(n("<span>").addClass("pages-wrapper").append(i))
            }, wrapTextNodes: function () {
                var t = !1, e = n([]);
                this.$paginator.contents().each(function () {
                    var i = n(this), o = "A" == this.tagName && !i.hasClass("showall") || "SPAN" == this.tagName;
                    o ? t = !0 : t && !o && "INPUT" != this.tagName && (i.detach(), e = e.add(i))
                }), n("<div>").addClass("label").append(e).appendTo(this.$paginator)
            }, run: function () {
                try {
                    this.removeSpacesBetweenPages(), this.wrapPages(), this.wrapTextNodes()
                } catch (t) {
                    console.error(t, t.stack)
                }
    ...
    29: [function (t, e, i) {
        ...
        o.prototype = {
            replaceLinkIcon: function (t) {
                var e = n(t);
                n("<span>").addClass("related-widget-wrapper-icon").insertAfter(e), e.remove()
            }, updateLinkIcons: function () {
                this.replaceLinkIcon('img[src*="admin/img/icon-addlink"], img[src*="admin/img/icon_addlink"]'), this.replaceLinkIcon('img[src*="admin/img/icon-changelink"], img[src*="admin/img/icon_changelink"]'), this.replaceLinkIcon('img[src*="admin/img/icon-deletelink"], img[src*="admin/img/icon_deletelink"]'), n('img[src*="admin/img/selector-search"]').remove(), n(".add-related, .add-another, .change-related, .delete-related, .related-lookup").addClass("initialized")
            }, run: function () {
                try {
    ...
    30: [function (t, e, i) {
        ...
        o.prototype = {
            updateObjectLinks: function () {
                var t = this.$inline.find(".inline_label"), e = t.find("> .inlinechangelink");
                t.find("+ a").addClass("inlineviewlink").text(""), e.text("").detach().insertAfter(t)
            }, run: function () {
                try {
            ...
            n(".inline-related:not(.tabular)").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
        ...
        o.prototype = {
            updateOriginalCell: function () {
                this.$inline.find("tr").each(function () {
                    var t = n(this).find("td.original p");
                    t.contents().each(function () {
                        var t = n(this);
                        return 3 == t.get(0).nodeType ? void t.remove() : t.hasClass("inlinechangelink") ? void 0 : (t.addClass("inlineviewlink"), !1)
                    }), t.find("a").text(""), 0 == t.children().length && t.parent().addClass("empty")
                })
            }, run: function () {
                try {
            ...
            n(".inline-related.tabular").each(function () {
                new o(n(this)).run()
            })
        })
    }, {jquery: 69}],
    32: [function (t, e, i) {
        ...
        o.prototype = {
            getToolbar: function (t) {
                var e = t.find("#toolbar");
                return 0 == e.length && (e = n("<div>").attr("id", "toolbar"), n("#changelist").prepend(e)), e
            }, updateToolbar: function (t) {
                var e = t.find('input[type="submit"]').val();
                t.find("#searchbar").attr("placeholder", e)
            }, moveFilters: function (t, e) {
                var i, o = e.find("#searchbar");
                t.find("#changelist-filter").children().each(function () {
                    var t = n(this);
                    if ("H3" == t.prop("tagName")) i = t.text(); else if ("UL" == t.prop("tagName")) {
                        var s = n("<select>"), r = t.find("li");
                        n.each(t.prop("attributes"), function () {
                            s.attr(this.name, this.value)
                        }), s.addClass("changelist-filter-select"), r.filter(".selected").length > 1 && s.attr("multiple", !0), r.each(function (t) {
                            var e = n(this), o = e.find("a"),
                                r = n("<option>").text(o.text()).attr("data-url", o.attr("href")).attr("selected", e.hasClass("selected"));
                            if (0 == t) {
                                null != i && r.text(i);
                                var a = n("<option>").attr("disabled", !0).text("---");
                                r = r.add(a)
                            }
                            s.append(r)
                        });
                        var a = n("<span>").addClass("changelist-filter-select-wrapper").append(s);
                        o.length ? a.insertAfter(o) : e.append(a), i = null
                    } else if (t.hasClass("changelist-filter-popup")) {
                        var l = t.find(".changelist-filter-popup-toggle"),
                            c = t.find(".changelist-filter-popup-content"),
                            a = n("<span>").addClass("changelist-filter-select-wrapper").append(t);
                        o.length ? a.insertAfter(o) : e.append(a), l.on("click", function (t) {
                            t.preventDefault(), t.stopPropagation(), c.toggleClass("visible")
                        }), c.on("click", function (t) {
                            t.stopPropagation()
                        }), n(document.body).on("click", function () {
                            c.removeClass("visible")
                        })
                    }
                }), t.find("#changelist-filter").remove()
            }, fixFloatLineBreak: function () {
                n("#content-main").each(function () {
                    var t = n(this);
                    n.each(["#toolbar", ".object-tools", "changeform-navigation"], function (e, i) {
                        var o = t.find(i).first();
                        if (0 != o.length) return n("<div>").addClass("clear").insertAfter(o), !1
                    })
                })
            }, run: function () {
                var t = this.getToolbar(this.$changelist);
                try {
                    this.updateToolbar(t), this.moveFilters(this.$changelist, t)
                } catch (e) {
                    console.error(e, e.stack)
                }
                try {
    ...
    33: [function (t, e, i) {
        ...
        o.prototype = {
            updateUserTools: function (t) {
                var e = n("<ul>").addClass("sidebar-dependent"), i = t.find("strong").first().text();
                n("<li>").addClass("user-tools-welcome-msg").text(i).appendTo(e).on("click", function () {
                    n(document.documentElement).hasClass("touchevents") && e.toggleClass("opened")
                }), t.find("a").each(function () {
                    var t = n(this);
                    n("<li>").addClass("user-tools-link").html(t).appendTo(e)
                }), t.empty().addClass("user-tools").append(e), e.on("mouseenter", function () {
                    e.addClass("opened")
                }).on("mouseleave", function () {
            ...
            n("#user-tools").each(function () {
                new o(n(this)).run()
            })
        })
    }, {browsernizr: 39, "browsernizr/test/touchevents": 54, jquery: 69}],
    34: [function (t, e, i) {
        var n = window.jQuery = t("jquery");
        jet = {jQuery: n}, t("./layout-updaters/actions"), t("./layout-updaters/breadcrumbs"), t("./layout-updaters/paginator"), t("./layout-updaters/toolbar"), t("./layout-updaters/object-tools"), t("./layout-updaters/user-tools"), t("./layout-updaters/changeform-tabs"), t("./layout-updaters/tabular-inline"), t("./layout-updaters/stacked-inline"), t("./layout-updaters/related-widget-wrapper"), t("./layout-updaters/delete-confirmation"), t("./layout-updaters/branding"), t("./layout-updaters/icons"), t("./features/sidebar/main"), t("./features/filters"), t("./features/changeform-tabs"), t("./features/checkboxes"), t("./features/date-time-widgets"), t("./features/inlines"), t("./features/changelist"), t("./features/tooltips"), t("./features/dashboard"), t("./features/changeform"), t("./features/themes"), t("./features/siblings"), t("./features/selects"), t("./features/related-popups"), t("./features/scroll-to-bottom-detector"), t("./features/touchmove-non-scrollable")
    }, {
        "./features/changeform": 2,
        "./features/changeform-tabs": 1,
        "./features/changelist": 3,
        "./features/checkboxes": 4,
        "./features/dashboard": 6,
        "./features/date-time-widgets": 7,
        "./features/filters": 8,
        "./features/inlines": 9,
        "./features/related-popups": 10,
        "./features/scroll-to-bottom-detector": 11,
        "./features/selects": 12,
        "./features/siblings": 13,
        "./features/sidebar/main": 16,
        "./features/themes": 18,
        "./features/tooltips": 19,
        "./features/touchmove-non-scrollable": 20,
        "./layout-updaters/actions": 21,
        "./layout-updaters/branding": 22,
        "./layout-updaters/breadcrumbs": 23,
        "./layout-updaters/changeform-tabs": 24,
        "./layout-updaters/delete-confirmation": 25,
        "./layout-updaters/icons": 26,
        "./layout-updaters/object-tools": 27,
        "./layout-updaters/paginator": 28,
        "./layout-updaters/related-widget-wrapper": 29,
        "./layout-updaters/stacked-inline": 30,
        "./layout-updaters/tabular-inline": 31,
        "./layout-updaters/toolbar": 32,
        "./layout-updaters/user-tools": 33,
        jquery: 69
    }],
    35: [function (t, e, i) {
        var n = t("jquery");
        n.expr[":"].icontains = n.expr.createPseudo(function (t) {
            return function (e) {
                return n(e).text().toUpperCase().indexOf(t.toUpperCase()) >= 0
            }
        })
    }, {jquery: 69}],
    36: [function (t, e, i) {
        var n = t("jquery");
        n.fn.slideFadeToggle = function (t, e, i) {
            return this.animate({opacity: "toggle", height: "toggle"}, t, e, i)
        }
    }, {jquery: 69}],
    37: [function (t, e, i) {
        e.exports = function (t) {
            return void 0 == window.django ? t : gettext(t)
        }
    }, {}],
    38: [function (t, e, i) {
        var n = t("jquery"), o = function (t) {
            void 0 == window.top[t] && (window.top[t] = []), this.name = t
        };
        o.prototype = {
            push: function (t) {
                t.top[this.name][t.top[this.name].length - 1] != t && t.top[this.name].push(t)
            }, pop: function () {
                window.top[this.name].pop()
            }, previous: function () {
                return void 0 == window.top[this.name] || !n.isArray(window.top[this.name]) || window.top[this.name].length < 2 ? null : window.top[this.name][window.top[this.name].length - 2]
            }
        }, e.exports = o
    }, {jquery: 69}],
    39: [function (t, e, i) {
        var n = t("./lib/Modernizr"), o = t("./lib/ModernizrProto"), s = t("./lib/classes"), r = t("./lib/testRunner"),
            a = t("./lib/setClasses");
        r(), a(s), delete o.addTest, delete o.addAsyncTest;
        for (var l = 0; l < n._q.length; l++) n._q[l]();
        e.exports = n
    }, {
        "./lib/Modernizr": 40,
        "./lib/ModernizrProto": 41,
        "./lib/classes": 42,
        "./lib/setClasses": 50,
        "./lib/testRunner": 51
    }],
    40: [function (t, e, i) {
        var n = t("./ModernizrProto.js"), o = function () {
        };
        o.prototype = n, o = new o, e.exports = o
    }, {"./ModernizrProto.js": 41}],
    41: [function (t, e, i) {
        var n = t("./tests.js"), o = {
            ...
            addTest: function (t, e, i) {
                n.push({name: t, fn: e, options: i})
            },
            addAsyncTest: function (t) {
                n.push({name: null, fn: t})
            }
        };
        e.exports = o
    }, {"./tests.js": 53}],
    ...
    43: [function (t, e, i) {
        function n() {
            return "function" != typeof document.createElement ? document.createElement(arguments[0]) : o ? document.createElementNS.call(document, "http://www.w3.org/2000/svg", arguments[0]) : document.createElement.apply(document, arguments)
        }
    ...
    45: [function (t, e, i) {
        ...
        var o = t("./createElement.js"), s = t("./isSVG.js");
        e.exports = n
    }, {"./createElement.js": 43, "./isSVG.js": 48}],
    46: [function (t, e, i) {
        function n(t, e, i, n) {
            var a, l, c, u, d = "modernizr", h = s("div"), p = r();
            if (parseInt(i, 10)) for (; i--;) c = s("div"), c.id = n ? n[i] : d + (i + 1), h.appendChild(c);
            return a = s("style"), a.type = "text/css", a.id = "s" + d, (p.fake ? p : h).appendChild(a), p.appendChild(h), a.styleSheet ? a.styleSheet.cssText = t : a.appendChild(document.createTextNode(t)), h.id = d, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = o.style.overflow, o.style.overflow = "hidden", o.appendChild(p)), l = e(h, t), p.fake ? (p.parentNode.removeChild(p), o.style.overflow = u, o.offsetHeight) : h.parentNode.removeChild(h), !!l
        }

        var o = (t("./ModernizrProto.js"), t("./docElement.js")), s = t("./createElement.js"), r = t("./getBody.js");
        e.exports = n
    }, {"./ModernizrProto.js": 41, "./createElement.js": 43, "./docElement.js": 44, "./getBody.js": 45}],
    47: [function (t, e, i) {
        function n(t, e) {
            return typeof t === e
        }
    ...
    48: [function (t, e, i) {
        var n = t("./docElement.js"), o = "svg" === n.nodeName.toLowerCase();
        e.exports = o
    }, {"./docElement.js": 44}],
    49: [function (t, e, i) {
        var n = t("./ModernizrProto.js"), o = n._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
        n._prefixes = o, e.exports = o
    }, {"./ModernizrProto.js": 41}],
    50: [function (t, e, i) {
        function n(t) {
            var e = s.className, i = o._config.classPrefix || "";
            if (r && (e = e.baseVal), o._config.enableJSClass) {
                var n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
                e = e.replace(n, "$1" + i + "js$2")
            }
            o._config.enableClasses && (e += " " + i + t.join(" " + i), r ? s.className.baseVal = e : s.className = e)
        }

        var o = t("./Modernizr.js"), s = t("./docElement.js"), r = t("./isSVG.js");
        e.exports = n
    }, {"./Modernizr.js": 40, "./docElement.js": 44, "./isSVG.js": 48}],
    51: [function (t, e, i) {
        function n() {
            var t, e, i, n, l, c, u;
            for (var d in o) if (o.hasOwnProperty(d)) {
                if (t = [], e = o[d], e.name && (t.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length)) for (i = 0; i < e.options.aliases.length; i++) t.push(e.options.aliases[i].toLowerCase());
                for (n = a(e.fn, "function") ? e.fn() : e.fn, l = 0; l < t.length; l++) c = t[l], u = c.split("."), 1 === u.length ? s[u[0]] = n : (!s[u[0]] || s[u[0]] instanceof Boolean || (s[u[0]] = new Boolean(s[u[0]])), s[u[0]][u[1]] = n), r.push((n ? "" : "no-") + u.join("-"))
            }
        }

        var o = t("./tests.js"), s = t("./Modernizr.js"), r = t("./classes.js"), a = t("./is.js");
        e.exports = n
    }, {"./Modernizr.js": 40, "./classes.js": 42, "./is.js": 47, "./tests.js": 53}],
    52: [function (t, e, i) {
        var n = t("./ModernizrProto.js"), o = t("./injectElementWithStyles.js"), s = n.testStyles = o;
        e.exports = s
    }, {"./ModernizrProto.js": 41, "./injectElementWithStyles.js": 46}],
    53: [function (t, e, i) {
        var n = [];
        e.exports = n
    }, {}],
    54: [function (t, e, i) {
        var n = t("./../lib/Modernizr.js"), o = t("./../lib/prefixes.js"), s = t("./../lib/testStyles.js");
        n.addTest("touchevents", function () {
            var t;
            if ("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch) t = !0; else {
                var e = ["@media (", o.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");
                s(e, function (e) {
                    t = 9 === e.offsetTop
                })
            }
    ...
    }, {"./../lib/Modernizr.js": 40, "./../lib/prefixes.js": 49, "./../lib/testStyles.js": 52}],
    55: [function (t, e, i) {
        !function (t) {
            ...
            return t.widget("ui.button", {
                ...
                _create: function () {
                    ...
                    var n = this, r = this.options, a = "checkbox" === this.type || "radio" === this.type,
                        l = a ? "" : "ui-state-active";
                ...
                _resetButton: function () {
                    ...
                    var e = this.buttonElement.removeClass(n),
                        ...
                        o = this.options.icons, s = o.primary && o.secondary, r = [];
            ...
            t.ui = t.ui || {}, t.extend(t.ui, {
                ...
                scrollParent: function (e) {
                    var i = this.css("position"), n = "absolute" === i,
                        o = e ? /(auto|scroll|hidden)/ : /(auto|scroll)/, s = this.parents().filter(function () {
                            var e = t(this);
    ...
    57: [function (t, e, i) {
        !function (t) {
            ...
            function o() {
                t.datepicker._isDisabledDatepicker(r.inline ? r.dpDiv.parent()[0] : r.input[0]) || (t(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), t(this).addClass("ui-state-hover"), this.className.indexOf("ui-datepicker-prev") !== -1 && t(this).addClass("ui-datepicker-prev-hover"), this.className.indexOf("ui-datepicker-next") !== -1 && t(this).addClass("ui-datepicker-next-hover"))
            }
            ...
            return t.extend(i.prototype, {
                ...
                _autoSize: function (t) {
                    if (this._get(t, "autoSize") && !t.inline) {
                        var e, i, n, o, s = new Date(2009, 11, 20), r = this._get(t, "dateFormat");
                ...
                _optionDatepicker: function (e, i, n) {
                    ...
                    return 2 === arguments.length && "string" == typeof i ? "defaults" === i ? t.extend({}, t.datepicker._defaults) : c ? "all" === i ? t.extend({}, c.settings) : this._get(c, i) : null : (o = i || {}, "string" == typeof i && (o = {}, o[i] = n), void (c && (this._curInst === c && this._hideDatepicker(), r = this._getDateDatepicker(e, !0), a = this._getMinMaxDate(c, "min"), l = this._getMinMaxDate(c, "max"), s(c.settings, o), null !== a && void 0 !== o.dateFormat && void 0 === o.minDate && (c.settings.minDate = this._formatDate(c, a)), null !== l && void 0 !== o.dateFormat && void 0 === o.maxDate && (c.settings.maxDate = this._formatDate(c, l)), "disabled" in o && (o.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)), this._attachments(t(e), c), this._autoSize(c), this._setDate(c, r), this._updateAlternate(c), this._updateDatepicker(c))))
                },
                ...
                _doKeyDown: function (e) {
                    var i, n, o, s = t.datepicker._getInst(e.target), r = !0, a = s.dpDiv.is(".ui-datepicker-rtl");
                ...
                _updateDatepicker: function (e) {
                    ...
                    l.length > 0 && o.apply(l.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), s > 1 && e.dpDiv.addClass("ui-datepicker-multi-" + s).css("width", a * s + "em"), e.dpDiv[(1 !== n[0] || 1 !== n[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e === t.datepicker._curInst && t.datepicker._datepickerShowing && t.datepicker._shouldFocusInput(e) && e.input.focus(), e.yearshtml && (i = e.yearshtml, setTimeout(function () {
                ...
                _checkOffset: function (e, i, n) {
                    var o = e.dpDiv.outerWidth(), s = e.dpDiv.outerHeight(), r = e.input ? e.input.outerWidth() : 0,
                ...
                _hideDatepicker: function (e) {
                    ...
                    !r || e && r !== t.data(e, "datepicker") || this._datepickerShowing && (i = this._get(r, "showAnim"), n = this._get(r, "duration"), o = function () {
                ...
                parseDate: function (e, i, n) {
                    ...
                    var o, s, r, a, l = 0, c = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff,
                        ...
                        b = !1, _ = function (t) {
                            ...
                            var e = _(t), n = "@" === t ? 14 : "!" === t ? 20 : "y" === t && e ? 4 : "o" === t ? 3 : 2,
                                o = "y" === t ? n : 1, s = new RegExp("^\\d{" + o + "," + n + "}"),
                                r = i.substring(l).match(s);
                            if (!r) throw"Missing number at position " + l;
                            return l += r[0].length, parseInt(r[0], 10)
                        }, k = function (e, n, o) {
                            var s = -1, r = t.map(_(e) ? o : n, function (t, e) {
                                return [[e, t]]
                            }).sort(function (t, e) {
                    ...
                    if (g === -1 ? g = (new Date).getFullYear() : g < 100 && (g += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (g <= u ? 0 : -100)), y > -1) for (m = 1, v = y; ;) {
                        if (s = this._getDaysInMonth(g, m - 1), v <= s) break;
                        m++, v -= s
                    }
                ...
                _setDateFromField: function (t, e) {
                    if (t.input.val() !== t.lastVal) {
                        var i = this._get(t, "dateFormat"), n = t.lastVal = t.input ? t.input.val() : null,
                            o = this._getDefaultDate(t), s = o, r = this._getFormatConfig(t);
                        try {
                ...
                _setDate: function (t, e, i) {
                    var n = !e, o = t.selectedMonth, s = t.selectedYear,
                ...
                _generateHTML: function (t) {
                    ...
                    for (t.drawMonth = J, t.drawYear = tt, i = this._get(t, "prevText"), i = B ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, J - K, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, tt, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e" : "w") + "'>" + i + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e" : "w") + "'>" + i + "</span></a>", o = this._get(t, "nextText"), o = B ? this.formatDate(o, this._daylightSavingAdjust(new Date(tt, J + K, 1)), this._getFormatConfig(t)) : o, s = this._canAdjustMonth(t, 1, tt, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w" : "e") + "'>" + o + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w" : "e") + "'>" + o + "</span></a>", r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? Q : R, r = B ? this.formatDate(r, a, this._getFormatConfig(t)) : r, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", c = F ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (W ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (W ? "" : l) + "</div>" : "", u = parseInt(this._get(t, "firstDay"), 10), u = isNaN(u) ? 0 : u, d = this._get(t, "showWeek"), h = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), y = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), _ = "", k = 0; k < X[0]; k++) {
                        for (x = "", this.maxRows = 4, C = 0; C < X[1]; C++) {
                            ...
                            for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === k ? W ? s : n : "") + (/all|right/.test(T) && 0 === k ? W ? n : s : "") + this._generateMonthYearHeader(t, J, tt, G, Z, k > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", I = d ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) P = (w + u) % 7, I += "<th scope='col'" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + h[P] + "'>" + p[P] + "</span></th>";
                            for (S += I + "</tr></thead><tbody>", j = this._getDaysInMonth(tt, J), tt === t.selectedYear && J === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, j)), N = (this._getFirstDayOfMonth(tt, J) - u + 7) % 7, A = Math.ceil((N + j) / 7), $ = V && this.maxRows > A ? this.maxRows : A, this.maxRows = $, E = this._daylightSavingAdjust(new Date(tt, J, 1 - N)), M = 0; M < $; M++) {
                            ...
                            J++, J > 11 && (J = 0, tt++), S += "</tbody></table>" + (V ? "</div>" + (X[0] > 0 && C === X[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), x += S
                        }
                        _ += x
                    }
                ...
                _generateMonthYearHeader: function (t, e, i, n, o, s, r, a) {
                    var l, c, u, d, h, p, f, g, m = this._get(t, "changeMonth"), v = this._get(t, "changeYear"),
                        y = this._get(t, "showMonthAfterYear"), b = "<div class='ui-datepicker-title'>", _ = "";
                    if (s || !m) _ += "<span class='ui-datepicker-month'>" + r[e] + "</span>"; else {
                        for (l = n && n.getFullYear() === i, c = o && o.getFullYear() === i, _ += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", u = 0; u < 12; u++) (!l || u >= n.getMonth()) && (!c || u <= o.getMonth()) && (_ += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + a[u] + "</option>");
                        _ += "</select>"
                    }
                    if (y || (b += _ + (!s && m && v ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", s || !v) b += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
                        for (d = this._get(t, "yearRange").split(":"), h = (new Date).getFullYear(), p = function (t) {
                            ...
                            return isNaN(e) ? h : e
                        }, f = p(d[0]), g = Math.max(f, p(d[1] || "")), f = n ? Math.max(f, n.getFullYear()) : f, g = o ? Math.min(g, o.getFullYear()) : g, t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; f <= g; f++) t.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
                        t.yearshtml += "</select>", b += t.yearshtml, t.yearshtml = null
                    }
                    return b += this._get(t, "yearSuffix"), y && (b += (!s && m && v ? "" : "&#xa0;") + _), b += "</div>"
                },
                _adjustInstDate: function (t, e, i) {
                    var n = t.drawYear + ("Y" === i ? e : 0), o = t.drawMonth + ("M" === i ? e : 0),
                ...
                _restrictMinMax: function (t, e) {
                    var i = this._getMinMaxDate(t, "min"), n = this._getMinMaxDate(t, "max"), o = i && e < i ? i : e;
                    return n && o > n ? n : o
                },
                ...
                _isInRange: function (t, e) {
                    var i, n, o = this._getMinMaxDate(t, "min"), s = this._getMinMaxDate(t, "max"), r = null, a = null,
                        l = this._get(t, "yearRange");
                    return l && (i = l.split(":"), n = (new Date).getFullYear(), r = parseInt(i[0], 10), a = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (r += n), i[1].match(/[+\-].*/) && (a += n)), (!o || e.getTime() >= o.getTime()) && (!s || e.getTime() <= s.getTime()) && (!r || e.getFullYear() >= r) && (!a || e.getFullYear() <= a)
                },
            ...
            return t.widget("ui.dialog", {
                ...
                _createButtons: function () {
                    ...
                    return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), t.isEmptyObject(i) || t.isArray(i) && !i.length ? void this.uiDialog.removeClass("ui-dialog-buttons") : (t.each(i, function (i, n) {
                        ...
                        n = t.isFunction(n) ? {
                            click: n,
                            text: i
                        } : n, n = t.extend({type: "button"}, n), o = n.click, n.click = function () {
                ...
                _makeDraggable: function () {
                    ...
                    this.uiDialog.draggable({
                        ...
                        stop: function (o, s) {
                            var r = s.offset.left - i.document.scrollLeft(), a = s.offset.top - i.document.scrollTop();
                            n.position = {
                                my: "left top",
                ...
                _makeResizable: function () {
                    ...
                    var i = this, n = this.options, o = n.resizable, s = this.uiDialog.css("position"),
        ...
        !function (t) {
            ...
            return t.widget("ui.draggable", t.ui.mouse, {
                ...
                _generatePosition: function (t, e) {
                    var i, n, o, s, r = this.options, a = this._isRootNode(this.scrollParent[0]), l = t.pageX,
                        c = t.pageY;
                    return a && this.offset.scroll || (this.offset.scroll = {
                        top: this.scrollParent.scrollTop(),
                        left: this.scrollParent.scrollLeft()
                    }), e && (this.containment && (this.relativeContainer ? (n = this.relativeContainer.offset(), i = [this.containment[0] + n.left, this.containment[1] + n.top, this.containment[2] + n.left, this.containment[3] + n.top]) : i = this.containment,
                ...
                start: function (e, i, n) {
                    ...
                    for (h = n.snapElements.length - 1; h >= 0; h--) l = n.snapElements[h].left - n.margins.left, c = l + n.snapElements[h].width, u = n.snapElements[h].top - n.margins.top, d = u + n.snapElements[h].height, v < l - g || m > c + g || b < u - g || y > d + g || !t.contains(n.snapElements[h].item.ownerDocument, n.snapElements[h].item) ? (n.snapElements[h].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {snapItem: n.snapElements[h].item})), n.snapElements[h].snapping = !1) : ("inner" !== f.snapMode && (o = Math.abs(u - b) <= g, s = Math.abs(d - y) <= g, r = Math.abs(l - v) <= g, a = Math.abs(c - m) <= g, o && (i.position.top = n._convertPositionTo("relative", {
                        ...
                        top: 0,
                        left: c
                    }).left)), p = o || s || r || a, "outer" !== f.snapMode && (o = Math.abs(u - y) <= g, s = Math.abs(d - b) <= g, r = Math.abs(l - m) <= g, a = Math.abs(c - v) <= g, o && (i.position.top = n._convertPositionTo("relative", {
                        top: u,
                        left: 0
                    }).top), s && (i.position.top = n._convertPositionTo("relative", {
                    ...
                    }).left)), !n.snapElements[h].snapping && (o || s || r || a || p) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {snapItem: n.snapElements[h].item})), n.snapElements[h].snapping = o || s || r || a || p)
                }
            ...
            return t.widget("ui.droppable", {
                ...
                _drop: function (e, i) {
                    ...
                    return !(!n || (n.currentItem || n.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                        ...
                        if (i.options.greedy && !i.options.disabled && i.options.scope === n.options.scope && i.accept.call(i.element[0], n.currentItem || n.element) && t.ui.intersect(n, t.extend(i, {offset: i.element.offset()}), i.options.tolerance, e)) return o = !0, !1
                ...
                return function (e, i, n, o) {
                    ...
                    var s = (e.positionAbs || e.position.absolute).left + e.margins.left,
                        ...
                        a = s + e.helperProportions.width, l = r + e.helperProportions.height, c = i.offset.left,
                        u = i.offset.top, d = c + i.proportions().width, h = u + i.proportions().height;
                    switch (n) {
                        case"fit":
                            return c <= s && a <= d && u <= r && l <= h;
                        case"intersect":
                            return c < s + e.helperProportions.width / 2 && a - e.helperProportions.width / 2 < d && u < r + e.helperProportions.height / 2 && l - e.helperProportions.height / 2 < h;
                        case"pointer":
                            return t(o.pageY, u, i.proportions().height) && t(o.pageX, c, i.proportions().width);
                        case"touch":
                ...
                current: null, droppables: {"default": []}, prepareOffsets: function (e, i) {
                    ...
                    e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
                        if (!this.options.disabled && !this.greedyChild && this.visible) {
                            var n, o, s, r = t.ui.intersect(e, this, this.options.tolerance, i),
            ...
            return function () {
                ...
                t.position = {
                    scrollbarWidth: function () {
                        ...
                        return {width: s ? t.position.scrollbarWidth() : 0, height: o ? t.position.scrollbarWidth() : 0}
                    ...
                    o = t.extend({}, o);
                    var p, g, m, v, y, b, _ = t(o.of), w = t.position.getWithinInfo(o.within),
                        k = t.position.getScrollInfo(w), x = (o.collision || "flip").split(" "), C = {};
                    return b = n(_), _[0].preventDefault && (o.at = "left top"), g = b.width, m = b.height, v = b.offset, y = t.extend({}, v), t.each(["my", "at"], function () {
                    ...
                    }), 1 === x.length && (x[1] = x[0]), "right" === o.at[0] ? y.left += g : "center" === o.at[0] && (y.left += g / 2), "bottom" === o.at[1] ? y.top += m : "center" === o.at[1] && (y.top += m / 2), p = e(C.at, g, m), y.left += p[0], y.top += p[1], this.each(function () {
                        var n, c, u = t(this), d = u.outerWidth(), h = u.outerHeight(), f = i(this, "marginLeft"),
                            b = i(this, "marginTop"), D = d + f + i(this, "marginRight") + k.width,
                            T = h + b + i(this, "marginBottom") + k.height, S = t.extend({}, y),
                            I = e(C.my, u.outerWidth(), u.outerHeight());
                        "right" === o.my[0] ? S.left -= d : "center" === o.my[0] && (S.left -= d / 2), "bottom" === o.my[1] ? S.top -= h : "center" === o.my[1] && (S.top -= h / 2), S.left += I[0], S.top += I[1], s || (S.left = l(S.left), S.top = l(S.top)), n = {
                            marginLeft: f,
                            marginTop: b
                            ...
                            var e = v.left - S.left, i = e + g - d, n = v.top - S.top, s = n + m - h, l = {
                            ...
                            g < d && a(e + i) < g && (l.horizontal = "center"), m < h && a(n + s) < m && (l.vertical = "middle"), r(a(e), a(i)) > r(a(n), a(s)) ? l.important = "horizontal" : l.important = "vertical", o.using.call(this, t, l)
                    ...
                    fit: {
                        left: function (t, e) {
                            var i, n = e.within, o = n.isWindow ? n.scrollLeft : n.offset.left, s = n.width,
                                a = t.left - e.collisionPosition.marginLeft, l = o - a,
                                c = a + e.collisionWidth - s - o;
                            e.collisionWidth > s ? l > 0 && c <= 0 ? (i = t.left + l + e.collisionWidth - s - o, t.left += l - i) : c > 0 && l <= 0 ? t.left = o : l > c ? t.left = o + s - e.collisionWidth : t.left = o : l > 0 ? t.left += l : c > 0 ? t.left -= c : t.left = r(t.left - a, t.left)
                        }, top: function (t, e) {
                            ...
                            e.collisionHeight > s ? l > 0 && c <= 0 ? (i = t.top + l + e.collisionHeight - s - o, t.top += l - i) : c > 0 && l <= 0 ? t.top = o : l > c ? t.top = o + s - e.collisionHeight : t.top = o : l > 0 ? t.top += l : c > 0 ? t.top -= c : t.top = r(t.top - a, t.top)
                        }
                    }, flip: {
                        left: function (t, e) {
                            var i, n, o = e.within, s = o.offset.left + o.scrollLeft, r = o.width,
                                ...
                                f = -2 * e.offset[0];
                            u < 0 ? (i = t.left + h + p + f + e.collisionWidth - r - s, (i < 0 || i < a(u)) && (t.left += h + p + f)) : d > 0 && (n = t.left - e.collisionPosition.marginLeft + h + p + f - l, (n > 0 || a(n) < d) && (t.left += h + p + f))
                        }, top: function (t, e) {
                            var i, n, o = e.within, s = o.offset.top + o.scrollTop, r = o.height,
                                ...
                                g = -2 * e.offset[1];
                            u < 0 ? (n = t.top + p + f + g + e.collisionHeight - r - s, (n < 0 || n < a(u)) && (t.top += p + f + g)) : d > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + g - l, (i > 0 || a(i) < d) && (t.top += p + f + g))
                        }
                    }, flipfit: {
                        left: function () {
                    ...
                    e.appendChild(l), i = a || document.documentElement, i.insertBefore(e, i.firstChild), l.style.cssText = "position: absolute; left: 10.7432222px;", o = t(l).offset().left, s = o > 10 && o < 11, e.innerHTML = "", i.removeChild(e)
                }()
            }(), t.ui.position
        })
    }, {}],
            ...
            return t.widget("ui.resizable", t.ui.mouse, {
                ...
                _create: function () {
                    ...
                    this._renderAxis = function (e) {
                        var i, n, o, s;
                        e = e || this.element;
                        for (i in this.handles) this.handles[i].constructor === String ? this.handles[i] = this.element.children(this.handles[i]).first().show() : (this.handles[i].jquery || this.handles[i].nodeType) && (this.handles[i] = t(this.handles[i]), this._on(this.handles[i], {mousedown: r._mouseDown})), this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && (n = t(this.handles[i], this.element), s = /sw|ne|nw|se|n|s/.test(i) ? n.outerHeight() : n.outerWidth(), o = ["padding", /ne|nw|n/.test(i) ? "Top" : /se|sw|s/.test(i) ? "Bottom" : /^e$/.test(i) ? "Right" : "Left"].join(""), e.css(o, s), this._proportionallyResize()), this._handles = this._handles.add(this.handles[i])
                ...
                _mouseDrag: function (e) {
                    var i, n, o = this.originalMousePosition, s = this.axis, r = e.pageX - o.left || 0,
                        a = e.pageY - o.top || 0, l = this._change[s];
                ...
                _mouseStop: function (e) {
                    ...
                    }, a = parseInt(u.element.css("left"), 10) + (u.position.left - u.originalPosition.left) || null, l = parseInt(u.element.css("top"), 10) + (u.position.top - u.originalPosition.top) || null, c.animate || this.element.css(t.extend(r, {
                        top: l,
                        left: a
                ...
                _applyChanges: function () {
                    var t = {};
                    return this.position.top !== this.prevPosition.top && (t.top = this.position.top + "px"), this.position.left !== this.prevPosition.left && (t.left = this.position.left + "px"), this.size.width !== this.prevSize.width && (t.width = this.size.width + "px"), this.size.height !== this.prevSize.height && (t.height = this.size.height + "px"),
                        this.helper.css(t), t
                },
                _updateVirtualBoundaries: function (t) {
                    ...
                    }, (this._aspectRatio || t) && (e = s.minHeight * this.aspectRatio, n = s.minWidth / this.aspectRatio, i = s.maxHeight * this.aspectRatio, o = s.maxWidth / this.aspectRatio, e > s.minWidth && (s.minWidth = e), n > s.minHeight && (s.minHeight = n), i < s.maxWidth && (s.maxWidth = i), o < s.maxHeight && (s.maxHeight = o)), this._vBoundaries = s
                },
                ...
                _respectSize: function (t) {
                    var e = this._vBoundaries, i = this.axis,
                        ...
                        l = this.position.top + this.size.height, c = /sw|nw|w/.test(i), u = /nw|ne|n/.test(i);
                    return s && (t.width = e.minWidth), r && (t.height = e.minHeight), n && (t.width = e.maxWidth), o && (t.height = e.maxHeight), s && c && (t.left = a - e.minWidth), n && c && (t.left = a - e.maxWidth), r && u && (t.top = l - e.minHeight), o && u && (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t
                },
                _getPaddingPlusBorderDimensions: function (t) {
                    for (var e = 0, i = [], n = [t.css("borderTopWidth"), t.css("borderRightWidth"), t.css("borderBottomWidth"), t.css("borderLeftWidth")], o = [t.css("paddingTop"), t.css("paddingRight"), t.css("paddingBottom"), t.css("paddingLeft")]; e < 4; e++) i[e] = parseInt(n[e], 10) || 0, i[e] += parseInt(o[e], 10) || 0;
                ...
                stop: function (e) {
                    var i = t(this).resizable("instance"), n = i.options, o = i._proportionallyResizeElements,
                        s = o.length && /textarea/i.test(o[0].nodeName),
                        r = s && i._hasScroll(o[0], "left") ? 0 : i.sizeDiff.height, a = s ? 0 : i.sizeDiff.width,
                ...
                start: function () {
                    var e, i, n, o, s, r, a, l = t(this).resizable("instance"), c = l.options, u = l.element,
                        d = c.containment, h = d instanceof t ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
                    ...
                    var i, n, o, s, r = t(this).resizable("instance"), a = r.options, l = r.containerOffset,
                        c = r.position, u = r._aspectRatio || e.shiftKey, d = {top: 0, left: 0}, h = r.containerElement,
                        p = !0;
                    ...
                    var e = t(this).resizable("instance"), i = e.options, n = e.containerOffset,
                        o = e.containerPosition, s = e.containerElement, r = t(e.helper), a = r.offset(),
                        l = r.outerWidth() - e.sizeDiff.width, c = r.outerHeight() - e.sizeDiff.height;
                ...
                start: function () {
                    ...
                    var n = t(this).resizable("instance"), o = n.options, s = n.originalSize, r = n.originalPosition,
                        a = {
            ...
            return t.widget("ui.sortable", t.ui.mouse, {
                ...
                _intersectsWith: function (t) {
                    var e = this.positionAbs.left, i = e + this.helperProportions.width, n = this.positionAbs.top,
                        ...
                        h = "y" === this.options.axis || e + u > s && e + u < r, p = d && h;
                ...
                _intersectsWithPointer: function (t) {
                    var e = "x" === this.options.axis || this._isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                        ...
                        n = e && i, o = this._getDragVerticalDirection(), s = this._getDragHorizontalDirection();
                ...
                _refreshItems: function (e) {
                    ...
                    var i, n, o, s, r, a, l, c, u = this.items,
                        ...
                        h = this._connectWith();
                    if (h && this.ready) for (i = h.length - 1; i >= 0; i--) for (o = t(h[i], this.document[0]), n = o.length - 1; n >= 0; n--) s = t.data(o[n], this.widgetFullName), s && s !== this && !s.options.disabled && (d.push([t.isFunction(s.options.items) ? s.options.items.call(s.element[0], e, {item: this.currentItem}) : t(s.options.items, s.element), s]), this.containers.push(s));
                    for (i = d.length - 1; i >= 0; i--) for (r = d[i][1], a = d[i][0], n = 0, c = a.length; n < c; n++) l = t(a[n]), l.data(this.widgetName + "-item", r), u.push({
                        item: l,
                        instance: r,
                        width: 0,
                        height: 0,
                ...
                _createPlaceholder: function (e) {
                    ...
                    n.placeholder && n.placeholder.constructor !== String || (i = n.placeholder, n.placeholder = {
                        element: function () {
                            ...
                            return "tbody" === n ? e._createTrPlaceholder(e.currentItem.find("tr").eq(0), t("<tr>", e.document[0]).appendTo(o)) : "tr" === n ? e._createTrPlaceholder(e.currentItem, o) : "img" === n && o.attr("src", e.currentItem.attr("src")), i || o.css("visibility", "hidden"), o
                        }, update: function (t, o) {
                ...
                _contactContainers: function (e) {
                    var i, n, o, s, r, a, l, c, u, d, h = null, p = null;
                    ...
                    if (h) if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", e, this._uiHash(this)), this.containers[p].containerCache.over = 1); else {
                        for (o = 1e4, s = null, u = h.floating || this._isFloating(this.currentItem), r = u ? "left" : "top", a = u ? "width" : "height", d = u ? "clientX" : "clientY", n = this.items.length - 1; n >= 0; n--) t.contains(this.containers[p].element[0], this.items[n].item[0]) && this.items[n].item[0] !== this.currentItem[0] && (l = this.items[n].item.offset()[r], c = !1, e[d] - l > this.items[n][a] / 2 && (c = !0), Math.abs(e[d] - l) < o && (o = Math.abs(e[d] - l), s = this.items[n], this.direction = c ? "up" : "down"));
            ...
            return t.widget("ui.tooltip", {
                version: "1.11.4", options: {
                    ...
                    var i = e.data("ui-tooltip-id"), n = (e.attr("aria-describedby") || "").split(/\s+/),
                        o = t.inArray(i, n);
                    o !== -1 && n.splice(o, 1), e.removeData("ui-tooltip-id"), n = t.trim(n.join(" ")), n ? e.attr("aria-describedby", n) : e.removeAttr("aria-describedby")
                }, _create: function () {
                    this._on({
                        mouseover: "open",
                        focusin: "open"
    ...
    66: [function (t, e, i) {
        !function (t) {
            ...
            return t.cleanData = function (e) {
                ...
                for (var n, o, s = i.call(arguments, 1), r = 0, a = s.length; r < a; r++) for (n in s[r]) o = s[r][n], s[r].hasOwnProperty(n) && void 0 !== o && (t.isPlainObject(o) ? e[n] = t.isPlainObject(e[n]) ? t.widget.extend({}, e[n], o) : t.widget.extend({}, o) : e[n] = o);
                return e
    ...
    67: [function (t, e, i) {
        !function (e) {
            ...
            var r = /\+/g, a = t.cookie = function (o, r, l) {
                ...
                for (var d = o ? void 0 : {}, h = document.cookie ? document.cookie.split("; ") : [], p = 0, f = h.length; p < f; p++) {
                    var g = h[p].split("="), m = i(g.shift()), v = g.join("=");
                    if (o && o === m) {
                        d = s(v, r);
                        break
                    }
    ...
    68: [function (t, e, i) {
        !function (t) {
            ...
            function e(e) {
                var r = e || window.event, a = l.call(arguments, 1), c = 0, u = 0, d = 0, h = 0;
                if (e = t.event.fix(r), e.type = "mousewheel", "detail" in r && (d = r.detail * -1), "wheelDelta" in r && (d = r.wheelDelta), "wheelDeltaY" in r && (d = r.wheelDeltaY), "wheelDeltaX" in r && (u = r.wheelDeltaX * -1), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (u = d * -1, d = 0), c = 0 === d ? u : d, "deltaY" in r && (d = r.deltaY * -1, c = d), "deltaX" in r && (u = r.deltaX, 0 === d && (c = u * -1)), 0 !== d || 0 !== u) {
                    ...
                    return h = Math.max(Math.abs(d), Math.abs(u)), (!s || h < s) && (s = h, n(r, h) && (s /= 40)), n(r, h) && (c /= 40, u /= 40, d /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), u = Math[u >= 1 ? "floor" : "ceil"](u / s), d = Math[d >= 1 ? "floor" : "ceil"](d / s), e.deltaX = u, e.deltaY = d, e.deltaFactor = s, e.deltaMode = 0, a.unshift(e, c, u, d), o && clearTimeout(o), o = setTimeout(i, 200), (t.event.dispatch || t.event.handle).apply(this, a)
                }
            }
    ...
    69: [function (t, e, i) {
        !function (t, i) {
            ...
            function i(t) {
                var e = "length" in t && t.length, i = ot.type(t);
            ...
            function u(t, e, i, n) {
                if (ot.acceptData(t)) {
                    ...
                    if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = a ? t[r] = K.pop() || ot.guid++ : r), l[c] || (l[c] = a ? {} : {toJSON: ot.noop}), "object" != typeof e && "function" != typeof e || (n ? l[c] = ot.extend(l[c], e) : l[c].data = ot.extend(l[c].data, e)), s = l[c], n || (s.data || (s.data = {}), s = s.data), void 0 !== i && (s[ot.camelCase(e)] = i), "string" == typeof e ? (o = s[e], null == o && (o = s[ot.camelCase(e)])) : o = s, o
                }
            }

            function d(t, e, i) {
                if (ot.acceptData(t)) {
                    var n, o, s = t.nodeType, r = s ? ot.cache : t, a = s ? t[ot.expando] : ot.expando;
                    if (r[a]) {
            ...
            function m(t, e) {
                ...
                if (!s) for (s = [], i = t.childNodes || t; null != (n = i[o]); o++) !e || ot.nodeName(n, e) ? s.push(n) : ot.merge(s, m(n, e));
            ...
            function k(t, e) {
                if (1 === e.nodeType && ot.hasData(t)) {
                    var i, n, o, s = ot._data(t), r = ot._data(e, s), a = s.events;
                    if (a) {
                        delete r.handle, r.events = {};
                        for (i in a) for (n = 0, o = a[i].length; n < o; n++) ot.event.add(e, i, a[i][n])
                    }
            ...
            function x(t, e) {
                ...
                if (1 === e.nodeType) {
                    ...
                    "script" === i && e.text !== t.text ? (b(e).text = t.text, _(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), it.html5Clone && t.innerHTML && !ot.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && jt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== i && "textarea" !== i || (e.defaultValue = t.defaultValue)
                }
            }
            ...
            function D(t) {
                var e = ft, i = Jt[t];
                return i || (i = C(t, e), "none" !== i && i || (Zt = (Zt || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Zt[0].contentWindow || Zt[0].contentDocument).document, e.write(), e.close(), i = C(t, e), Zt.detach()), Jt[t] = i), i
            }
            ...
            function S(t, e) {
                if (e in t) return e;
                for (var i = e.charAt(0).toUpperCase() + e.slice(1), n = e, o = he.length; o--;) if (e = he[o] + i, e in t) return e;
                return n
            }

            function I(t, e) {
                for (var i, n, o, s = [], r = 0, a = t.length; r < a; r++) n = t[r], n.style && (s[r] = ot._data(n, "olddisplay"), i = n.style.display, e ? (s[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && It(n) && (s[r] = ot._data(n, "olddisplay", D(n.nodeName)))) : (o = It(n), (i && "none" !== i || !o) && ot._data(n, "olddisplay", o ? i : ot.css(n, "display"))));
            ...
            function j(t, e, i, n, o) {
                for (var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; s < 4; s += 2) "margin" === i && (r += ot.css(t, i + St[s], !0, o)), n ? ("content" === i && (r -= ot.css(t, "padding" + St[s], !0, o)), "margin" !== i && (r -= ot.css(t, "border" + St[s] + "Width", !0, o))) : (r += ot.css(t, "padding" + St[s], !0, o), "padding" !== i && (r += ot.css(t, "border" + St[s] + "Width", !0, o)));
                return r
            }

            function N(t, e, i) {
                var n = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, s = te(t),
                    r = it.boxSizing && "border-box" === ot.css(t, "boxSizing", !1, s);
                if (o <= 0 || null == o) {
                    if (o = ee(t, e, s), (o < 0 || null == o) && (o = t.style[e]), ne.test(o)) return o;
            ...
            function E(t, e) {
                ...
                for (e = e ? 1 : 0; o < 4; o += 2 - e) i = St[o], n["margin" + i] = n["padding" + i] = t;
                return e && (n.opacity = n.width = t), n
            }

            function M(t, e, i) {
                for (var n, o = (be[e] || []).concat(be["*"]), s = 0, r = o.length; s < r; s++) if (n = o[s].call(i, e, t)) return n
            }

            function H(t, e, i) {
                var n, o, s, r, a, l, c, u, d = this, h = {}, p = t.style, f = t.nodeType && It(t),
                    g = ot._data(t, "fxshow");
                ...
                })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], c = ot.css(t, "display"), u = "none" === c ? ot._data(t, "olddisplay") || D(t.nodeName) : c, "inline" === u && "none" === ot.css(t, "float") && (it.inlineBlockNeedsLayout && "inline" !== D(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), i.overflow && (p.overflow = "hidden", it.shrinkWrapBlocks() || d.always(function () {
                    p.overflow = i.overflow[0], p.overflowX = i.overflow[1], p.overflowY = i.overflow[2]
                }));
                for (n in e) if (o = e[n], ge.exec(o)) {
                ...
                if (ot.isEmptyObject(h)) "inline" === ("none" === c ? D(t.nodeName) : c) && (p.display = c); else {
                    g ? "hidden" in g && (f = g.hidden) : g = ot._data(t, "fxshow", {}), s && (g.hidden = !f), f ? ot(t).show() : d.done(function () {
                        ot(t).hide()
                    }), d.done(function () {
                        var e;
                    ...
                    for (n in h) r = M(f ? g[n] : 0, n, d), n in g || (g[n] = r.start, f && (r.end = r.start, r.start = "width" === n || "height" === n ? 1 : 0))
                }
            }

            function L(t, e) {
                var i, n, o, s, r;
                for (i in t) if (n = ot.camelCase(i), o = e[n], s = t[i], ot.isArray(s) && (o = s[1], s = t[i] = s[0]), i !== n && (t[n] = s, delete t[i]), r = ot.cssHooks[n], r && "expand" in r) {
            ...
            function z(t, e, i) {
                var n, o, s = 0, r = ye.length, a = ot.Deferred().always(function () {
                    delete l.elem
                }), l = function () {
                    if (o) return !1;
                    for (var e = pe || $(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, s = 1 - n, r = 0, l = c.tweens.length; r < l; r++) c.tweens[r].run(s);
                ...
                for (L(u, c.opts.specialEasing); s < r; s++) if (n = ye[s].call(c, t, u, c.opts)) return n;
            ...
            function O(t) {
                return function (e, i) {
                    ...
                    var n, o = 0, s = e.toLowerCase().match(bt) || [];
                    if (ot.isFunction(i)) for (; n = s[o++];) "+" === n.charAt(0) ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
                }
            }
            ...
            function Y(t, e, i, n) {
                ...
                if (ot.isArray(e)) ot.each(e, function (e, o) {
                    i || Ue.test(t) ? n(t, o) : Y(t + "[" + ("object" == typeof o ? e : "") + "]", o, i, n)
                }); else if (i || "object" !== ot.type(e)) n(t, e); else for (o in e) Y(t + "[" + o + "]", e[o], i, n)
            }
            ...
            var K = [], V = K.slice, Q = K.concat, G = K.push, Z = K.indexOf, J = {}, tt = J.toString,
                et = J.hasOwnProperty, it = {}, nt = "1.11.3", ot = function (t, e) {
                    return new ot.fn.init(t, e)
                }, st = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, rt = /^-ms-/, at = /-([\da-z])/gi, lt = function (t, e) {
                    return e.toUpperCase()
                };
            ot.fn = ot.prototype = {
                jquery: nt, constructor: ot, selector: "", length: 0, toArray: function () {
                    return V.call(this)
                }, get: function (t) {
                ...
                for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || ot.isFunction(r) || (r = {}), a === l && (r = this, a--); a < l; a++) if (null != (o = arguments[a])) for (n in o) t = r[n], i = o[n], r !== i && (c && i && (ot.isPlainObject(i) || (e = ot.isArray(i))) ? (e ? (e = !1, s = t && ot.isArray(t) ? t : []) : s = t && ot.isPlainObject(t) ? t : {}, r[n] = ot.extend(c, s, i)) : void 0 !== i && (r[n] = i));
                return r
            }, ot.extend({
                expando: "jQuery" + (nt + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
                    ...
                    if (n) {
                        if (a) for (; s < r && (o = e.apply(t[s], n), o !== !1); s++) ; else for (s in t) if (o = e.apply(t[s], n), o === !1) break
                    } else if (a) for (; s < r && (o = e.call(t[s], s, t[s]), o !== !1); s++) ; else for (s in t) if (o = e.call(t[s], s, t[s]), o === !1) break;
                    return t
                }, trim: function (t) {
                    return null == t ? "" : (t + "").replace(st, "")
                }, makeArray: function (t, e) {
                    var n = e || [];
                    return null != t && (i(Object(t)) ? ot.merge(n, "string" == typeof t ? [t] : t) : G.call(n, t)), n
                    ...
                    if (a) for (; s < r; s++) o = e(t[s], s, n), null != o && l.push(o); else for (s in t) o = e(t[s], s, n), null != o && l.push(o);
                    return Q.apply([], l)
                }, guid: 1, proxy: function (t, e) {
                    var i, n, o;
                    if ("string" == typeof e && (o = t[e], e = t, t = o), ot.isFunction(t)) return i = V.call(arguments, 2), n = function () {
            ...
            var ct = function (t) {
                function e(t, e, i, n) {
                    ...
                    if ((e ? e.ownerDocument || e : q) !== A && N(e), e = e || A, i = i || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return i;
                    if (!n && E) {
                        ...
                        if (w.qsa && (!M || !M.test(t))) {
                            if (p = d = O, f = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                                for (c = D(t), (d = e.getAttribute("id")) ? p = d.replace(_t, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + h(c[l]);
                ...
                function p(t, e, i) {
                    ...
                    return e.first ? function (e, i, s) {
                        ...
                        if (r) {
                            ...
                            if (l = e[O] || (e[O] = {}), (a = l[n]) && a[0] === R && a[1] === s) return c[2] = a[2];
                ...
                function v(t, e, i, o, s, r) {
                    return o && !o[O] && (o = v(o)), s && !s[O] && (s = v(s, r)), n(function (n, r, a, l) {
                        var c, u, d, h = [], p = [], f = r.length, v = n || g(e || "*", a.nodeType ? [a] : a, []),
                            y = !t || !n && e ? v : m(v, h, t, a, l), b = i ? s || (n ? t : f || o) ? [] : r : y;
                        if (i && i(y, b, a, l), o) for (c = m(b, p), o(c, [], a, l), u = c.length; u--;) (d = c[u]) && (b[p[u]] = !(y[p[u]] = d));
                        if (n) {
                            if (s || t) {
                                if (s) {
                                ...
                                for (u = b.length; u--;) (d = b[u]) && (c = s ? tt(n, d) : h[u]) > -1 && (n[c] = !(r[c] = d))
                            }
                        } else b = m(b === r ? b.splice(f, b.length) : b), s ? s(null, r, b, l) : Z.apply(r, b)
                    })
                }
                ...
                function y(t) {
                    for (var e, i, n, o = t.length, s = k.relative[t[0].type], r = s || k.relative[" "], a = s ? 1 : 0, l = p(function (t) {
                        ...
                        var o = !s && (n || i !== I) || ((e = i).nodeType ? l(t, i, n) : c(t, i, n));
                        return e = null, o
                    }]; a < o; a++) if (i = k.relative[t[a].type]) u = [p(f(u), i)]; else {
                        if (i = k.filter[t[a].type].apply(null, t[a].matches), i[O]) {
                            for (n = ++a; n < o && !k.relative[t[n].type]; n++) ;
                            return v(a > 1 && f(u), a > 1 && h(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(lt, "$1"), i, a < n && y(t.slice(a, n)), n < o && y(t = t.slice(n)), n < o && h(t))
                        }
                        u.push(i)
                    }
                    return f(u)
                ...
                function b(t, i) {
                    var o = i.length > 0, s = t.length > 0, r = function (n, r, a, l, c) {
                        var u, d, h, p = 0, f = "0", g = n && [], v = [], y = I, b = n || s && k.find.TAG("*", c),
                            _ = R += null == y ? 1 : Math.random() || .1, w = b.length;
                        for (c && (I = r !== A && r); f !== w && null != (u = b[f]); f++) {
                            if (s && u) {
                ...
                var _, w, k, x, C, D, T, S, I, P, j, N, A, $, E, M, H, L, z, O = "sizzle" + 1 * new Date,
                    q = t.document, R = 0, W = 0, F = i(), Y = i(), B = i(), X = function (t, e) {
                        return t === e && (j = !0), 0
                    }, U = 1 << 31, K = {}.hasOwnProperty, V = [], Q = V.pop, G = V.push, Z = V.push, J = V.slice,
                    tt = function (t, e) {
                    ...
                    dt = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]", "g"), ht = new RegExp(rt),
                    pt = new RegExp("^" + ot + "$"), ft = {
                        ID: new RegExp("^#(" + nt + ")"),
                        CLASS: new RegExp("^\\.(" + nt + ")"),
                    ...
                    yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, _t = /'|\\/g,
                    wt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)", "ig"), kt = function (t, e, i) {
                        var n = "0x" + e - 65536;
                ...
                try {
                    Z.apply(V = J.call(q.childNodes), q.childNodes), V[q.childNodes.length].nodeType
                } catch (Ct) {
                    Z = {
                ...
                w = e.support = {}, C = e.isXML = function (t) {
                    ...
                    return n !== A && 9 === n.nodeType && n.documentElement ? (A = n, $ = n.documentElement, i = n.defaultView, i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", xt, !1) : i.attachEvent && i.attachEvent("onunload", xt)), E = !C(n), w.attributes = o(function (t) {
                        return t.className = "i", !t.getAttribute("className")
                    }), w.getElementsByTagName = o(function (t) {
                        return t.appendChild(n.createComment("")), !t.getElementsByTagName("*").length
                    }), w.getElementsByClassName = vt.test(n.getElementsByClassName), w.getById = o(function (t) {
                        return $.appendChild(t).id = O, !n.getElementsByName || !n.getElementsByName(O).length
                        ...
                        if (E) return e.getElementsByClassName(t)
                    }, H = [], M = [], (w.qsa = vt.test(n.querySelectorAll)) && (o(function (t) {
                    ...
                    })), (w.matchesSelector = vt.test(L = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && o(function (t) {
                        w.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), H.push("!=", rt)
                    }), M = M.length && new RegExp(M.join("|")), H = H.length && new RegExp(H.join("|")), e = vt.test($.compareDocumentPosition), z = e || vt.test($.contains) ? function (t, e) {
                        ...
                        return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === q && z(q, t) ? -1 : e === n || e.ownerDocument === q && z(q, e) ? 1 : P ? tt(P, t) - tt(P, e) : 0 : 4 & i ? -1 : 1)
                    } : function (t, e) {
                        if (t === e) return j = !0, 0;
                        var i, o = 0, s = t.parentNode, a = e.parentNode, l = [t], c = [e];
                        if (!s || !a) return t === n ? -1 : e === n ? 1 : s ? -1 : a ? 1 : P ? tt(P, t) - tt(P, e) : 0;
                        if (s === a) return r(t, e);
                        for (i = t; i = i.parentNode;) l.unshift(i);
                        for (i = e; i = i.parentNode;) c.unshift(i);
                        for (; l[o] === c[o];) o++;
                        return o ? r(l[o], c[o]) : l[o] === q ? -1 : c[o] === q ? 1 : 0
                    }, n) : A
                }, e.matches = function (t, i) {
                    return e(t, null, null, i)
                }, e.matchesSelector = function (t, i) {
                    if ((t.ownerDocument || t) !== A && N(t), i = i.replace(dt, "='$1']"), w.matchesSelector && E && (!H || !H.test(i)) && (!M || !M.test(i))) try {
                        var n = L.call(t, i);
                    ...
                    preFilter: {
                        ATTR: function (t) {
                            ...
                            var e, i = !t[6] && t[2];
                            return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ht.test(i) && (e = D(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function (t) {
                            ...
                            return 1 === n && 0 === o ? function (t) {
                                ...
                                var c, u, d, h, p, f, g = s !== r ? "nextSibling" : "previousSibling", m = e.parentNode,
                                ...
                                if (m) {
                                    ...
                                    if (f = [r ? m.firstChild : m.lastChild], r && y) {
                                        for (u = m[O] || (m[O] = {}), c = u[t] || [], p = c[0] === R && c[1], h = c[0] === R && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (h = p = 0) || f.pop();) if (1 === d.nodeType && ++h && d === e) {
                                            u[t] = [R, p, h];
                                            break
                                        }
                                    } else if (y && (c = (e[O] || (e[O] = {}))[t]) && c[0] === R) h = c[1]; else for (; (d = ++p && d && d[g] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++h || (y && ((d[O] || (d[O] = {}))[t] = [R, h]), d !== e));) ;
                                    return h -= o, h === n || h % n === 0 && h / n >= 0
                                }
                            }
                        }, PSEUDO: function (t, i) {
                            var o,
                                s = k.pseudos[t] || k.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                            return s[O] ? s(i) : s.length > 1 ? (o = [t, t, "", i], k.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
                    ...
                    pseudos: {
                        not: n(function (t) {
                            ...
                            return t = t.replace(wt, kt), function (e) {
                                return (e.textContent || e.innerText || x(e)).indexOf(t) > -1
                            }
                        }), lang: n(function (t) {
                            return pt.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(wt, kt).toLowerCase(), function (e) {
                                var i;
                                do if (i = E ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return i = i.toLowerCase(), i === t || 0 === i.indexOf(t + "-"); while ((e = e.parentNode) && 1 === e.nodeType);
                                return !1
                            }
                        }), target: function (e) {
                ...
                return d.prototype = k.filters = k.pseudos, k.setFilters = new d, D = e.tokenize = function (t, i) {
                    ...
                    var i, n = [], o = [], s = B[t + " "];
                    if (!s) {
                        for (e || (e = D(t)), i = e.length; i--;) s = y(e[i]), s[O] ? n.push(s) : o.push(s);
                        s = B(t, b(o, n)), s.selector = t
                    }
                    return s
                }, S = e.select = function (t, e, i, n) {
                    var o, s, r, a, l, c = "function" == typeof t && t, d = !n && D(t = c.selector || t);
                    if (i = i || [], 1 === d.length) {
                        if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && w.getById && 9 === e.nodeType && E && k.relative[s[1].type]) {
                            if (e = (k.find.ID(r.matches[0].replace(wt, kt), e) || [])[0], !e) return i;
                            c && (e = e.parentNode), t = t.slice(s.shift().value.length)
                        }
                        for (o = ft.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !k.relative[a = r.type]);) if ((l = k.find[a]) && (n = l(r.matches[0].replace(wt, kt), bt.test(s[0].type) && u(e.parentNode) || e))) {
                            if (s.splice(o, 1), t = n.length && h(s), !t) return Z.apply(i, n), i;
                            break
                        }
                    }
                    return (c || T(t, d))(n, e, !E, i, bt.test(t) && u(e.parentNode) || e), i
                }, w.sortStable = O.split("").sort(X).join("") === O, w.detectDuplicates = !!j, N(), w.sortDetached = o(function (t) {
            ...
            ot.filter = function (t, e, i) {
                ...
                find: function (t) {
                    ...
                    if ("string" != typeof t) return this.pushStack(ot(t).filter(function () {
                        for (e = 0; e < o; e++) if (ot.contains(n[e], this)) return !0
                    }));
                    ...
                    return !!n(this, "string" == typeof t && ut.test(t) ? ot(t) : t || [], !1).length
                }
            });
            var pt, ft = t.document, gt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, mt = ot.fn.init = function (t, e) {
                var i, n;
                if (!t) return this;
                if ("string" == typeof t) {
                    ...
                    if (i[1]) {
                        if (e = e instanceof ot ? e[0] : e, ot.merge(this, ot.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : ft, !0)), dt.test(i[1]) && ot.isPlainObject(e)) for (i in e) ot.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                        return this
                    }
            ...
            ot.extend({
                ...
                has: function (t) {
                    ...
                    return this.filter(function () {
                        for (e = 0; e < n; e++) if (ot.contains(this, i[e])) return !0
                    })
                }, closest: function (t, e) {
                    for (var i, n = 0, o = this.length, s = [], r = ut.test(t) || "string" != typeof t ? ot(t, e || this.context) : 0; n < o; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && ot.find.matchesSelector(i, t))) {
                        s.push(i);
                        break
                    }
            ...
            ot.Callbacks = function (t) {
                t = "string" == typeof t ? _t[t] || s(t) : ot.extend({}, t);
                var e, i, n, o, r, a, l = [], c = !t.once && [], u = function (s) {
                    for (i = t.memory && s, n = !0, r = a || 0, a = 0, o = l.length, e = !0; l && r < o; r++) if (l[r].apply(s[0], s[1]) === !1 && t.stopOnFalse) {
                        i = !1;
                        break
                    }
                    ...
                    add: function () {
                        ...
                        return l && ot.each(arguments, function (t, i) {
                            for (var n; (n = ot.inArray(i, l, n)) > -1;) l.splice(n, 1), e && (n <= o && o--, n <= r && r--)
                        }), this
                    }, has: function (t) {
                ...
                Deferred: function (t) {
                    ...
                    var e, i, n, o = 0, s = V.call(arguments), r = s.length,
                    ...
                    if (r > 1) for (e = new Array(r), i = new Array(r), n = new Array(r); o < r; o++) s[o] && ot.isFunction(s[o].promise) ? s[o].promise().done(c(o, n, s)).fail(l.reject).progress(c(o, i, e)) : --a;
            ...
            ot.extend({
                ...
                queue: function (t, e, i) {
                    ...
                    e = e || "fx";
                    var i = ot.queue(t, e), n = i.length, o = i.shift(), s = ot._queueHooks(t, e), r = function () {
                        ot.dequeue(t, e)
                    };
                ...
                queue: function (t, e) {
                    ...
                    var i, n = 1, o = ot.Deferred(), s = this, r = this.length, a = function () {
                        --n || o.resolveWith(s, [s])
                    };
            ...
            var Tt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, St = ["Top", "Right", "Bottom", "Left"],
                It = function (t, e) {
                    return t = e || t, "none" === ot.css(t, "display") || !ot.contains(t.ownerDocument, t)
                }, Pt = ot.access = function (t, e, i, n, o, s, r) {
            ...
            var Nt = /^(?:input|select|textarea)$/i, At = /^key/, $t = /^(?:mouse|pointer|contextmenu)|click/,
                Et = /^(?:focusinfocus|focusoutblur)$/, Mt = /^([^.]*)(?:\.(.+)|)$/;
            ot.event = {
                global: {},
                add: function (t, e, i, n, o) {
                    var s, r, a, l, c, u, d, h, p, f, g, m = ot._data(t);
                    if (m) {
                        for (i.handler && (l = i, i = l.handler, o = l.selector), i.guid || (i.guid = ot.guid++), (r = m.events) || (r = m.events = {}), (u = m.handle) || (u = m.handle = function (t) {
                            return typeof ot === xt || t && ot.event.triggered === t.type ? void 0 : ot.event.dispatch.apply(u.elem, arguments)
                        }, u.elem = t), e = (e || "").match(bt) || [""], a = e.length; a--;) s = Mt.exec(e[a]) || [], p = g = s[1], f = (s[2] || "").split(".").sort(), p && (c = ot.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = ot.event.special[p] || {}, d = ot.extend({
                            type: p,
                            origType: g,
                            data: n,
                            handler: i,
                            ...
                            namespace: f.join(".")
                        }, l), (h = r[p]) || (h = r[p] = [], h.delegateCount = 0, c.setup && c.setup.call(t, n, f, u) !== !1 || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), ot.event.global[p] = !0);
                        t = null
                    }
                },
                remove: function (t, e, i, n, o) {
                    var s, r, a, l, c, u, d, h, p, f, g, m = ot.hasData(t) && ot._data(t);
                    if (m && (u = m.events)) {
                        for (e = (e || "").match(bt) || [""], c = e.length; c--;) if (a = Mt.exec(e[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                            for (d = ot.event.special[p] || {}, p = (n ? d.delegateType : d.bindType) || p, h = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = h.length; s--;) r = h[s], !o && g !== r.origType || i && i.guid !== r.guid || a && !a.test(r.namespace) || n && n !== r.selector && ("**" !== n || !r.selector) || (h.splice(s, 1), r.selector && h.delegateCount--, d.remove && d.remove.call(t, r));
                            l && !h.length && (d.teardown && d.teardown.call(t, f, m.handle) !== !1 || ot.removeEvent(t, p, m.handle), delete u[p])
                        } else for (p in u) ot.event.remove(t, p + e[c], i, n, !0);
                        ot.isEmptyObject(u) && (delete m.handle, ot._removeData(t, "events"))
                    }
                },
                trigger: function (e, i, n, o) {
                    var s, r, a, l, c, u, d, h = [n || ft], p = et.call(e, "type") ? e.type : e,
                        f = et.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (a = u = n = n || ft, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(p + ot.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), r = p.indexOf(":") < 0 && "on" + p, e = e[ot.expando] ? e : new ot.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ot.makeArray(i, [e]), c = ot.event.special[p] || {}, o || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                        if (!o && !c.noBubble && !ot.isWindow(n)) {
                            for (l = c.delegateType || p, Et.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), u = a;
                            u === (n.ownerDocument || ft) && h.push(u.defaultView || u.parentWindow || t)
                        }
                        for (d = 0; (a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : c.bindType || p, s = (ot._data(a, "events") || {})[e.type] && ot._data(a, "handle"), s && s.apply(a, i), s = r && a[r], s && s.apply && ot.acceptData(a) && (e.result = s.apply(a, i), e.result === !1 && e.preventDefault());
                        if (e.type = p, !o && !e.isDefaultPrevented() && (!c._default || c._default.apply(h.pop(), i) === !1) && ot.acceptData(n) && r && n[p] && !ot.isWindow(n)) {
                            u = n[r], u && (n[r] = null), ot.event.triggered = p;
                            try {
                                n[p]()
                            } catch (g) {
                            }
                            ot.event.triggered = void 0, u && (n[r] = u)
                        }
                        return e.result
                    }
                },
                dispatch: function (t) {
                    t = ot.event.fix(t);
                    var e, i, n, o, s, r = [], a = V.call(arguments),
                        l = (ot._data(this, "events") || {})[t.type] || [], c = ot.event.special[t.type] || {};
                    if (a[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
                        for (r = ot.event.handlers.call(this, t, l), e = 0; (o = r[e++]) && !t.isPropagationStopped();) for (t.currentTarget = o.elem, s = 0; (n = o.handlers[s++]) && !t.isImmediatePropagationStopped();) t.namespace_re && !t.namespace_re.test(n.namespace) || (t.handleObj = n, t.data = n.data, i = ((ot.event.special[n.origType] || {}).handle || n.handler).apply(o.elem, a), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                handlers: function (t, e) {
                    ...
                    if (a && l.nodeType && (!t.button || "click" !== t.type)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                        for (o = [], s = 0; s < a; s++) n = e[s], i = n.selector + " ", void 0 === o[i] && (o[i] = n.needsContext ? ot(i, this).index(l) >= 0 : ot.find(i, this, null, [l]).length), o[i] && o.push(n);
                ...
                fix: function (t) {
                    ...
                    for (r || (this.fixHooks[o] = r = $t.test(o) ? this.mouseHooks : At.test(o) ? this.keyHooks : {}), n = r.props ? this.props.concat(r.props) : this.props, t = new ot.Event(s), e = n.length; e--;) i = n[e], t[i] = s[i];
                ...
                simulate: function (t, e, i, n) {
                    var o = ot.extend(new ot.Event, i, {type: t, isSimulated: !0, originalEvent: {}});
            ...
            }), it.focusinBubbles || ot.each({focus: "focusin", blur: "focusout"}, function (t, e) {
                var i = function (t) {
                    ot.event.simulate(e, t.target, ot.event.fix(t), !0)
                };
                ot.event.special[e] = {
                    setup: function () {
                        var n = this.ownerDocument || this, o = ot._data(n, e);
                        o || n.addEventListener(t, i, !0), ot._data(n, e, (o || 0) + 1)
                    }, teardown: function () {
                        var n = this.ownerDocument || this, o = ot._data(n, e) - 1;
            ...
            var Ht = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
                Lt = / jQuery\d+="(?:null|\d+)"/g, zt = new RegExp("<(?:" + Ht + ")[\\s/>]", "i"), Ot = /^\s+/,
                qt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Rt = /<([\w:]+)/,
                Wt = /<tbody/i, Ft = /<|&#?\w+;/, Yt = /<(?:script|style|link)/i,
                Bt = /checked\s*(?:[^=]|=\s*.checked.)/i, Xt = /^$|\/(?:java|ecma)script/i, Ut = /^true\/(.*)/,
                Kt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Vt = {
                ...
                }, Qt = g(ft), Gt = Qt.appendChild(ft.createElement("div"));
            Vt.optgroup = Vt.option, Vt.tbody = Vt.tfoot = Vt.colgroup = Vt.caption = Vt.thead, Vt.th = Vt.td, ot.extend({
                clone: function (t, e, i) {
                    ...
                    if (it.html5Clone || ot.isXMLDoc(t) || !zt.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (Gt.innerHTML = t.outerHTML, Gt.removeChild(s = Gt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t))) for (n = m(s), a = m(t), r = 0; null != (o = a[r]); ++r) n[r] && x(o, n[r]);
                    if (e) if (i) for (a = a || m(t), n = n || m(s), r = 0; null != (o = a[r]); r++) k(o, n[r]); else k(t, s);
                    return n = m(s, "script"), n.length > 0 && w(n, !l && m(t, "script")), n = a = o = null, s
                }, buildFragment: function (t, e, i, n) {
                    for (var o, s, r, a, l, c, u, d = t.length, h = g(e), p = [], f = 0; f < d; f++) if (s = t[f], s || 0 === s) if ("object" === ot.type(s)) ot.merge(p, s.nodeType ? [s] : s); else if (Ft.test(s)) {
                        for (a = a || h.appendChild(e.createElement("div")), l = (Rt.exec(s) || ["", ""])[1].toLowerCase(), u = Vt[l] || Vt._default, a.innerHTML = u[1] + s.replace(qt, "<$1></$2>") + u[2], o = u[0]; o--;) a = a.lastChild;
                        if (!it.leadingWhitespace && Ot.test(s) && p.push(e.createTextNode(Ot.exec(s)[0])), !it.tbody) for (s = "table" !== l || Wt.test(s) ? "<table>" !== u[1] || Wt.test(s) ? 0 : a : a.firstChild, o = s && s.childNodes.length; o--;) ot.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
                        for (ot.merge(p, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
                        a = h.lastChild
                    } else p.push(e.createTextNode(s));
                    for (a && h.removeChild(a), it.appendChecked || ot.grep(m(p, "input"), v), f = 0; s = p[f++];) if ((!n || ot.inArray(s, n) === -1) && (r = ot.contains(s.ownerDocument, s), a = m(h.appendChild(s), "script"), r && w(a), i)) for (o = 0; s = a[o++];) Xt.test(s.type || "") && i.push(s);
                    return a = null, h
                }, cleanData: function (t, e) {
                    for (var i, n, o, s, r = 0, a = ot.expando, l = ot.cache, c = it.deleteExpando, u = ot.event.special; null != (i = t[r]); r++) if ((e || ot.acceptData(i)) && (o = i[a], s = o && l[o])) {
                        if (s.events) for (n in s.events) u[n] ? ot.event.remove(i, n) : ot.removeEvent(i, n, s.handle);
                        l[o] && (delete l[o], c ? delete i[a] : typeof i.removeAttribute !== xt ? i.removeAttribute(a) : i[a] = null, K.push(o))
                    }
                }
            }), ot.fn.extend({
                text: function (t) {
                    ...
                    for (var i, n = t ? ot.filter(t, this) : this, o = 0; null != (i = n[o]); o++) e || 1 !== i.nodeType || ot.cleanData(m(i)), i.parentNode && (e && ot.contains(i.ownerDocument, i) && w(m(i, "script")), i.parentNode.removeChild(i));
                    return this
                }, empty: function () {
                    ...
                    return Pt(this, function (t) {
                        ...
                        if ("string" == typeof t && !Yt.test(t) && (it.htmlSerialize || !zt.test(t)) && (it.leadingWhitespace || !Ot.test(t)) && !Vt[(Rt.exec(t) || ["", ""])[1].toLowerCase()]) {
                            t = t.replace(qt, "<$1></$2>");
                            try {
                                for (; i < n; i++) e = this[i] || {}, 1 === e.nodeType && (ot.cleanData(m(e, !1)), e.innerHTML = t);
                                e = 0
                            } catch (o) {
                            }
                        }
                    ...
                    t = Q.apply([], t);
                    var i, n, o, s, r, a, l = 0, c = this.length, u = this, d = c - 1, h = t[0], p = ot.isFunction(h);
                    if (p || c > 1 && "string" == typeof h && !it.checkClone && Bt.test(h)) return this.each(function (i) {
                        var n = u.eq(i);
                    ...
                    if (c && (a = ot.buildFragment(t, this[0].ownerDocument, !1, this), i = a.firstChild, 1 === a.childNodes.length && (a = i), i)) {
                        for (s = ot.map(m(a, "script"), b), o = s.length; l < c; l++) n = a, l !== d && (n = ot.clone(n, !0, !0), o && ot.merge(s, m(n, "script"))), e.call(this[l], n, l);
                        if (o) for (r = s[s.length - 1].ownerDocument, ot.map(s, _), l = 0; l < o; l++) n = s[l], Xt.test(n.type || "") && !ot._data(n, "globalEval") && ot.contains(r, n) && (n.src ? ot._evalUrl && ot._evalUrl(n.src) : ot.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Kt, "")));
                        a = i = null
                    }
                    return this
                }
                ...
                ot.fn[t] = function (t) {
                    for (var i, n = 0, o = [], s = ot(t), r = s.length - 1; n <= r; n++) i = n === r ? this : this.clone(!0), ot(s[n])[e](i), G.apply(o, i.get());
            ...
            var te, ee, ie = /^margin/, ne = new RegExp("^(" + Tt + ")(?!px)[a-z%]+$", "i"),
            ...
            ot.extend({
                ...
                css: function (t, e, i, n) {
                    ...
                    return e = ot.cssProps[a] || (ot.cssProps[a] = S(t.style, a)), r = ot.cssHooks[e] || ot.cssHooks[a], r && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = ee(t, e, n)), "normal" === s && e in de && (s = de[e]), "" === i || i ? (o = parseFloat(s), i === !0 || ot.isNumeric(o) ? o || 0 : s) : s
                }
            }), ot.each(["height", "width"], function (t, e) {
                ot.cssHooks[e] = {
                    get: function (t, i, n) {
                        if (i) return ae.test(ot.css(t, "display")) && 0 === t.offsetWidth ? ot.swap(t, ue, function () {
                            return N(t, e, n)
                        }) : N(t, e, n)
                    }, set: function (t, i, n) {
                        var o = n && te(t);
                        return P(t, i, n ? j(t, e, n, it.boxSizing && "border-box" === ot.css(t, "boxSizing", !1, o), o) : 0)
                    }
                }
                ...
                get: function (t, e) {
                    ...
                    var i = t.style, n = t.currentStyle, o = ot.isNumeric(e) ? "alpha(opacity=" + 100 * e + ")" : "",
                ...
                }, ie.test(t) || (ot.cssHooks[t + e].set = P)
            }), ot.fn.extend({
                css: function (t, e) {
                    return Pt(this, function (t, e, i) {
                        var n, o, s = {}, r = 0;
                        if (ot.isArray(e)) {
                            for (n = te(t), o = e.length; r < o; r++) s[e[r]] = ot.css(t, e[r], !1, n);
                            return s
                        }
                ...
                constructor: A, init: function (t, e, i, n, o, s) {
                    ...
                    return this.options.duration ? this.pos = e = ot.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : A.propHooks._default.set(this), this
                }
            ...
            var pe, fe, ge = /^(?:toggle|show|hide)$/, me = new RegExp("^(?:([+-])=|)(" + Tt + ")([a-z%]*)$", "i"),
                ve = /queueHooks$/, ye = [H], be = {
                    "*": [function (t, e) {
                        var i = this.createTween(t, e), n = i.cur(), o = me.exec(e),
                            s = o && o[3] || (ot.cssNumber[t] ? "" : "px"),
                            r = (ot.cssNumber[t] || "px" !== s && +n) && me.exec(ot.css(i.elem, t)), a = 1, l = 20;
                        if (r && r[3] !== s) {
                            s = s || r[3], o = o || [], r = +n || 1;
            ...
            ot.Animation = ot.extend(z, {
                tweener: function (t, e) {
                    ...
                    for (var i, n = 0, o = t.length; n < o; n++) i = t[n], be[i] = be[i] || [], be[i].unshift(e)
                ...
                fadeTo: function (t, e, i, n) {
                    ...
                    var o = ot.isEmptyObject(t), s = ot.speed(e, i, n), r = function () {
                        var e = z(this, ot.extend({}, t), s);
                    ...
                    return "string" != typeof t && (i = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                        ...
                        if (o) r[o] && r[o].stop && n(r[o]); else for (o in r) r[o] && r[o].stop && ve.test(o) && n(r[o]);
                        for (o = s.length; o--;) s[o].elem !== this || null != t && s[o].queue !== t || (s[o].anim.stop(i), e = !1, s.splice(o, 1));
                        !e && i || ot.dequeue(this, t)
                    })
                }, finish: function (t) {
                    return t !== !1 && (t = t || "fx"), this.each(function () {
                        var e, i = ot._data(this), n = i[t + "queue"], o = i[t + "queueHooks"], s = ot.timers,
                            r = n ? n.length : 0;
                ...
                ot.fn[e] = function (t, n, o) {
                    return null == t || "boolean" == typeof t ? i.apply(this, arguments) : this.animate(E(e, !0), t, n, o)
                }
            }), ot.each({
                slideDown: E("show"),
                slideUp: E("hide"),
            ...
            ot.fn.extend({
                val: function (t) {
                    var e, i, n, o = this[0];
                    {
                        ...
                        if (o) return e = ot.valHooks[o.type] || ot.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : (i = o.value, "string" == typeof i ? i.replace(_e, "") : null == i ? "" : i)
                    }
                }
            }), ot.extend({
                valHooks: {
                    option: {
                        ...
                        get: function (t) {
                            for (var e, i, n = t.options, o = t.selectedIndex, s = "select-one" === t.type || o < 0, r = s ? null : [], a = s ? o + 1 : n.length, l = o < 0 ? a : s ? o : 0; l < a; l++) if (i = n[l], (i.selected || l === o) && (it.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !ot.nodeName(i.parentNode, "optgroup"))) {
                                if (e = ot(i).val(), s) return e;
                                r.push(e)
                            }
                            return r
                        }, set: function (t, e) {
                            for (var i, n, o = t.options, s = ot.makeArray(e), r = o.length; r--;) if (n = o[r], ot.inArray(ot.valHooks.option.get(n), s) >= 0) try {
                                n.selected = i = !0
                            } catch (a) {
                                n.scrollHeight
                            } else n.selected = !1;
            ...
            var we, ke, xe = ot.expr.attrHandle, Ce = /^(?:checked|selected)$/i, De = it.getSetAttribute, Te = it.input;
            ot.fn.extend({
                attr: function (t, e) {
                ...
                attr: function (t, e, i) {
                    ...
                    if (t && 3 !== s && 8 !== s && 2 !== s) return typeof t.getAttribute === xt ? ot.prop(t, e, i) : (1 === s && ot.isXMLDoc(t) || (e = e.toLowerCase(), n = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? ke : we)), void 0 === i ? n && "get" in n && null !== (o = n.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? void 0 : o) : null !== i ? n && "set" in n && void 0 !== (o = n.set(t, i, e)) ? o : (t.setAttribute(e, i + ""),
                        i) : void ot.removeAttr(t, e))
                }, removeAttr: function (t, e) {
                    var i, n, o = 0, s = e && e.match(bt);
                    if (s && 1 === t.nodeType) for (; i = s[o++];) n = ot.propFix[i] || i, ot.expr.match.bool.test(i) ? Te && De || !Ce.test(i) ? t[n] = !1 : t[ot.camelCase("default-" + i)] = t[n] = !1 : ot.attr(t, i, ""), t.removeAttribute(De ? i : n)
                }, attrHooks: {
                    type: {
                        set: function (t, e) {
                ...
                set: function (t, e, i) {
                    return e === !1 ? ot.removeAttr(t, i) : Te && De || !Ce.test(i) ? t.setAttribute(!De && ot.propFix[i] || i, i) : t[ot.camelCase("default-" + i)] = t[i] = !0, i
                }
            }, ot.each(ot.expr.match.bool.source.match(/\w+/g), function (t, e) {
                var i = xe[e] || ot.find.attr;
                xe[e] = Te && De || !Ce.test(e) ? function (t, e, n) {
                    var o, s;
                    return n || (s = xe[e], xe[e] = o, o = null != i(t, e, n) ? e.toLowerCase() : null, xe[e] = s), o
                } : function (t, e, i) {
                    if (!i) return t[ot.camelCase("default-" + e)] ? e.toLowerCase() : null
                }
            }), Te && De || (ot.attrHooks.value = {
                set: function (t, e, i) {
            ...
            var Se = /^(?:input|select|textarea|button|object)$/i, Ie = /^(?:a|area)$/i;
            ot.fn.extend({
                prop: function (t, e) {
                ...
                propFix: {"for": "htmlFor", "class": "className"}, prop: function (t, e, i) {
                    ...
                    if (t && 3 !== r && 8 !== r && 2 !== r) return s = 1 !== r || !ot.isXMLDoc(t), s && (e = ot.propFix[e] || e, o = ot.propHooks[e]), void 0 !== i ? o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : t[e] = i : o && "get" in o && null !== (n = o.get(t, e)) ? n : t[e]
                }, propHooks: {
                    tabIndex: {
                        get: function (t) {
            ...
            ot.fn.extend({
                addClass: function (t) {
                    ...
                    if (c) for (e = (t || "").match(bt) || []; a < l; a++) if (i = this[a], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Pe, " ") : " ")) {
                        for (s = 0; o = e[s++];) n.indexOf(" " + o + " ") < 0 && (n += o + " ");
                        r = ot.trim(n), i.className !== r && (i.className = r)
                    }
                    return this
                }, removeClass: function (t) {
                    var e, i, n, o, s, r, a = 0, l = this.length,
                    ...
                    return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function (i) {
                        ...
                        if ("string" === i) for (var e, n = 0, o = ot(this), s = t.match(bt) || []; e = s[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else i !== xt && "boolean" !== i || (this.className && ot._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ot._data(this, "__className__") || "")
                    })
                }, hasClass: function (t) {
                    for (var e = " " + t + " ", i = 0, n = this.length; i < n; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(Pe, " ").indexOf(e) >= 0) return !0;
                    return !1
                }
            ...
            ot.parseJSON = function (e) {
                ...
                return o && !ot.trim(o.replace(Ae, function (t, e, o, s) {
            ...
            var $e, Ee, Me = /#.*$/, He = /([?&])_=[^&]*/, Le = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
                ze = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Oe = /^(?:GET|HEAD)$/, qe = /^\/\//,
                Re = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, We = {}, Fe = {},
                Ye = "*/".concat("*");
            try {
                Ee = location.href
            ...
            $e = Re.exec(Ee.toLowerCase()) || [], ot.extend({
                active: 0,
                lastModified: {},
                etag: {},
                ajaxSettings: {
                ...
                ajax: function (t, e) {
                    function i(t, e, i, n) {
                        var o, u, v, y, _, k = e;
                        2 !== b && (b = 2, a && clearTimeout(a), c = void 0, r = n || "", w.readyState = t > 0 ? 4 : 0, o = t >= 200 && t < 300 || 304 === t, i && (y = W(d, w, i)), y = F(d, y, w, o), o ? (d.ifModified && (_ = w.getResponseHeader("Last-Modified"), _ && (ot.lastModified[s] = _), _ = w.getResponseHeader("etag"), _ && (ot.etag[s] = _)), 204 === t || "HEAD" === d.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = y.state, u = y.data, v = y.error, o = !v)) : (v = k, !t && k || (k = "error", t < 0 && (t = 0))), w.status = t, w.statusText = (e || k) + "", o ? f.resolveWith(h, [u, k, w]) : f.rejectWith(h, [w, k, v]), w.statusCode(m), m = void 0, l && p.trigger(o ? "ajaxSuccess" : "ajaxError", [w, d, o ? u : v]), g.fireWith(h, [w, k]), l && (p.trigger("ajaxComplete", [w, d]), --ot.active || ot.event.trigger("ajaxStop")))
                    }

                    "object" == typeof t && (e = t, t = void 0), e = e || {};
                    var n, o, s, r, a, l, c, u, d = ot.ajaxSetup({}, e), h = d.context || d,
                        p = d.context && (h.nodeType || h.jquery) ? ot(h) : ot.event, f = ot.Deferred(),
                        g = ot.Callbacks("once memory"), m = d.statusCode || {}, v = {}, y = {}, b = 0, _ = "canceled",
                        w = {
                            readyState: 0, getResponseHeader: function (t) {
                                var e;
                                if (2 === b) {
                                    if (!u) for (u = {}; e = Le.exec(r);) u[e[1].toLowerCase()] = e[2];
                                    e = u[t.toLowerCase()]
                                }
                    ...
                    if (f.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Ee) + "").replace(Me, "").replace(qe, $e[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (n = Re.exec(d.url.toLowerCase()), d.crossDomain = !(!n || n[1] === $e[1] && n[2] === $e[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === ($e[3] || ("http:" === $e[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), q(We, d, e, w), 2 === b) return w;
                    l = ot.event && d.global, l && 0 === ot.active++ && ot.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Oe.test(d.type), s = d.url, d.hasContent || (d.data && (s = d.url += (Ne.test(s) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = He.test(s) ? s.replace(He, "$1_=" + je++) : s + (Ne.test(s) ? "&" : "?") + "_=" + je++)), d.ifModified && (ot.lastModified[s] && w.setRequestHeader("If-Modified-Since", ot.lastModified[s]), ot.etag[s] && w.setRequestHeader("If-None-Match", ot.etag[s])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ye + "; q=0.01" : "") : d.accepts["*"]);
            ...
            ot.param = function (t, e) {
                ...
                serialize: function () {
                    ...
                    return this.map(function () {
                        ...
                        var t = this.type;
                        return this.name && !ot(this).is(":disabled") && Qe.test(this.nodeName) && !Ve.test(t) && (this.checked || !jt.test(t))
                    }).map(function (t, e) {
                        var i = ot(this).val();
            ...
            var Ge = 0, Ze = {}, Je = ot.ajaxSettings.xhr();
            t.attachEvent && t.attachEvent("onunload", function () {
                for (var t in Ze) Ze[t](void 0, !0)
            }), it.cors = !!Je && "withCredentials" in Je, Je = it.ajax = !!Je, Je && ot.ajaxTransport(function (t) {
            ...
            ot.ajaxSetup({
                ...
                if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(ei, "$1" + o) : e.jsonp !== !1 && (e.url += (Ne.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            ...
            ot.offset = {
                setOffset: function (t, e, i) {
                    var n, o, s, r, a, l, c, u = ot.css(t, "position"), d = ot(t), h = {};
                    "static" === u && (t.style.position = "relative"), a = d.offset(), s = ot.css(t, "top"), l = ot.css(t, "left"), c = ("absolute" === u || "fixed" === u) && ot.inArray("auto", [s, l]) > -1, c ? (n = d.position(), r = n.top, o = n.left) : (r = parseFloat(s) || 0, o = parseFloat(l) || 0), ot.isFunction(e) && (e = e.call(t, i, a)), null != e.top && (h.top = e.top - a.top + r), null != e.left && (h.left = e.left - a.left + o), "using" in e ? e.using.call(t, h) : d.css(h)
                }
            }, ot.fn.extend({
                offset: function (t) {
                ...
                ot.cssHooks[e] = T(it.pixelPosition, function (t, i) {
                    if (i) return i = ee(t, e), ne.test(i) ? ot(t).position()[e] + "px" : i
                })
    ...
    }, {"./plugin/destroy": 79, "./plugin/initialize": 87, "./plugin/update": 90}],
    78: [function (t, e, i) {
        "use strict";
        e.exports = {
            wheelSpeed: 1,
    ...
    }, {"../lib/dom": 73, "../lib/helper": 76, "./instances": 88}],
    80: [function (t, e, i) {
        "use strict";
        ...
        function n(t, e) {
            ...
            e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarY, "click", n), e.event.bind(e.scrollbarYRail, "click", function (n) {
                var s = o.toInt(e.scrollbarYHeight / 2),
                    a = e.railYRatio * (n.pageY - window.scrollY - i(e.scrollbarYRail).top - s),
                    l = e.railYRatio * (e.railYHeight - e.scrollbarYHeight), c = a / l;
                c < 0 ? c = 0 : c > 1 && (c = 1), t.scrollTop = (e.contentHeight - e.containerHeight) * c, r(t), n.stopPropagation()
                ...
                var s = o.toInt(e.scrollbarXWidth / 2),
                    a = e.railXRatio * (n.pageX - window.scrollX - i(e.scrollbarXRail).left - s),
                    l = e.railXRatio * (e.railXWidth - e.scrollbarXWidth), c = a / l;
                c < 0 ? c = 0 : c > 1 && (c = 1), t.scrollLeft = (e.contentWidth - e.containerWidth) * c - e.negativeScrollAdjustment, r(t), n.stopPropagation()
            })
        }

        var o = t("../../lib/helper"), s = t("../instances"), r = t("../update-geometry");
        e.exports = function (t) {
            var e = s.get(t);
            n(t, e)
        }
    }, {"../../lib/helper": 76, "../instances": 88, "../update-geometry": 89}],
    81: [function (t, e, i) {
        "use strict";
        ...
        function n(t, e) {
            function i(i) {
                var o = n + i * e.railXRatio,
                    s = e.scrollbarXRail.getBoundingClientRect().left + e.railXRatio * (e.railXWidth - e.scrollbarXWidth);
            ...
            var n = null, o = null, a = function (e) {
            ...
            e.event.bind(e.scrollbarX, "mousedown", function (i) {
                o = i.pageX, n = r.toInt(s.css(e.scrollbarX, "left")) * e.railXRatio, r.startScrolling(t, "x"), e.event.bind(e.ownerDocument, "mousemove", a), e.event.once(e.ownerDocument, "mouseup", c), i.stopPropagation(), i.preventDefault()
            })
        }
        ...
        function o(t, e) {
            function i(i) {
                var o = n + i * e.railYRatio,
                    s = e.scrollbarYRail.getBoundingClientRect().top + e.railYRatio * (e.railYHeight - e.scrollbarYHeight);
            ...
            e.event.bind(e.scrollbarY, "mousedown", function (i) {
                o = i.pageY, n = r.toInt(s.css(e.scrollbarY, "top")) * e.railYRatio, r.startScrolling(t, "y"), e.event.bind(e.ownerDocument, "mousemove", a), e.event.once(e.ownerDocument, "mouseup", c), i.stopPropagation(), i.preventDefault()
            })
        }

        var s = t("../../lib/dom"), r = t("../../lib/helper"), a = t("../instances"), l = t("../update-geometry");
        e.exports = function (t) {
            var e = a.get(t);
            n(t, e), o(t, e)
        }
    }, {"../../lib/dom": 73, "../../lib/helper": 76, "../instances": 88, "../update-geometry": 89}],
    82: [function (t, e, i) {
        "use strict";
        ...
        function n(t, e) {
            ...
            e.event.bind(e.ownerDocument, "keydown", function (a) {
                if ((!a.isDefaultPrevented || !a.isDefaultPrevented()) && n) {
                    ...
                    t.scrollTop = t.scrollTop - u, t.scrollLeft = t.scrollLeft + c, r(t), s = i(c, u), s && a.preventDefault()
                }
            })
        }
    ...
    84: [function (t, e, i) {
        ...
        var o = t("../instances"), s = t("../update-geometry");
        e.exports = function (t) {
            var e = o.get(t);
            n(t, e)
        }
    }, {"../instances": 88, "../update-geometry": 89}],
    85: [function (t, e, i) {
        "use strict";
        ...
        function n(t, e) {
            ...
            function n() {
                l || (l = setInterval(function () {
                    return s.get(t) ? (t.scrollTop = t.scrollTop + c.top, t.scrollLeft = t.scrollLeft + c.left, void r(t)) : void clearInterval(l)
                }, 50))
            }
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function () {
                t.contains(i()) ? u = !0 : (u = !1, a())
            }), e.event.bind(window, "mouseup", function () {
                u && (u = !1, a())
            }), e.event.bind(window, "mousemove", function (e) {
                if (u) {
                    var i = {x: e.pageX, y: e.pageY}, s = {
                        left: t.offsetLeft,
                        right: t.offsetLeft + t.offsetWidth,
                        top: t.offsetTop,
                        bottom: t.offsetTop + t.offsetHeight
                    };
                    i.x < s.left + 3 ? (c.left = -5, o.startScrolling(t, "x")) : i.x > s.right - 3 ? (c.left = 5, o.startScrolling(t, "x")) : c.left = 0, i.y < s.top + 3 ? (s.top + 3 - i.y < 5 ? c.top = -5 : c.top = -20, o.startScrolling(t, "y")) : i.y > s.bottom - 3 ? (i.y - s.bottom + 3 < 5 ? c.top = 5 : c.top = 20, o.startScrolling(t, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? a() : n()
                }
            })
        }
    ...
    86: [function (t, e, i) {
        ...
        function n(t, e, i, n) {
            function r(i, n) {
                var o = t.scrollTop, s = t.scrollLeft, r = Math.abs(i), a = Math.abs(n);
                if (a > r) {
            ...
            function h(t) {
                if (d(t)) {
                    _ = !0;
                    var e = u(t);
                    g.pageX = e.pageX, g.pageY = e.pageY, m = (new Date).getTime(), null !== y && clearInterval(y), t.stopPropagation()
                }
            }

            function p(t) {
                if (!b && _ && d(t)) {
                    var e = u(t), i = {pageX: e.pageX, pageY: e.pageY}, n = i.pageX - g.pageX, o = i.pageY - g.pageY;
                    a(n, o), g = i;
                    var s = (new Date).getTime(), l = s - m;
                    l > 0 && (v.x = n / l, v.y = o / l, m = s), r(n, o) && (t.stopPropagation(), t.preventDefault())
                }
            }

            function f() {
                !b && _ && (_ = !1, clearInterval(y), y = setInterval(function () {
                    return o.get(t) ? Math.abs(v.x) < .01 && Math.abs(v.y) < .01 ? void clearInterval(y) : (a(30 * v.x, 30 * v.y), v.x *= .8, void (v.y *= .8)) : void clearInterval(y)
                }, 10))
            }

            var g = {}, m = 0, v = {}, y = null, b = !1, _ = !1;
            i && (e.event.bind(window, "touchstart", l), e.event.bind(window, "touchend", c), e.event.bind(t, "touchstart", h), e.event.bind(t, "touchmove", p), e.event.bind(t, "touchend", f)), n && (window.PointerEvent ? (e.event.bind(window, "pointerdown", l), e.event.bind(window, "pointerup", c), e.event.bind(t, "pointerdown", h), e.event.bind(t, "pointermove", p), e.event.bind(t, "pointerup", f)) : window.MSPointerEvent && (e.event.bind(window, "MSPointerDown", l), e.event.bind(window, "MSPointerUp", c), e.event.bind(t, "MSPointerDown", h), e.event.bind(t, "MSPointerMove", p), e.event.bind(t, "MSPointerUp", f)))
        }
    ...
    87: [function (t, e, i) {
        ...
        var n = t("../lib/class"), o = t("../lib/helper"), s = t("./instances"), r = t("./update-geometry"),
            ...
            u = t("./handler/mouse-wheel"), d = t("./handler/native-scroll"), h = t("./handler/selection"),
            p = t("./handler/touch");
        e.exports = function (t, e) {
            e = "object" == typeof e ? e : {}, n.add(t, "ps-container");
            var i = s.add(t);
            i.settings = o.extend(i.settings, e), a(t), l(t), u(t), d(t), h(t), (o.env.supportsTouch || o.env.supportsIePointer) && p(t, o.env.supportsTouch, o.env.supportsIePointer), i.settings.useKeyboard && c(t), r(t)
        }
    }, {
        "../lib/class": 72,
        "../lib/helper": 76,
        "./handler/click-rail": 80,
        "./handler/drag-scrollbar": 81,
        "./handler/keyboard": 82,
        "./handler/mouse-wheel": 83,
        "./handler/native-scroll": 84,
        "./handler/selection": 85,
        "./handler/touch": 86,
        "./instances": 88,
        "./update-geometry": 89
    }],
    88: [function (t, e, i) {
        ...
        var a = t("../lib/dom"), l = t("./default-setting"), c = t("../lib/event-manager"), u = t("../lib/guid"),
            d = t("../lib/helper"), h = {};
        i.add = function (t) {
            var e = u();
    ...
    }, {"../lib/dom": 73, "../lib/event-manager": 74, "../lib/guid": 75, "../lib/helper": 76, "./default-setting": 78}],
    89: [function (t, e, i) {
        "use strict";
    ...
    }, {"../lib/class": 72, "../lib/dom": 73, "../lib/helper": 76, "./instances": 88}],
    90: [function (t, e, i) {
        "use strict";
        var n = t("../lib/dom"), o = t("../lib/helper"), s = t("./instances"), r = t("./update-geometry");
        e.exports = function (t) {
            var e = s.get(t);
            e && (e.negativeScrollAdjustment = e.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, n.css(e.scrollbarXRail, "display", "block"), n.css(e.scrollbarYRail, "display", "block"), e.railXMarginWidth = o.toInt(n.css(e.scrollbarXRail, "marginLeft")) + o.toInt(n.css(e.scrollbarXRail, "marginRight")), e.railYMarginHeight = o.toInt(n.css(e.scrollbarYRail, "marginTop")) + o.toInt(n.css(e.scrollbarYRail, "marginBottom")), n.css(e.scrollbarXRail, "display", "none"), n.css(e.scrollbarYRail, "display", "none"), r(t), n.css(e.scrollbarXRail, "display", ""), n.css(e.scrollbarYRail, "display", ""))
        }
    }, {"../lib/dom": 73, "../lib/helper": 76, "./instances": 88, "./update-geometry": 89}],
    91: [function (t, e, i) {
        !function (e) {
                ...
                return function () {
                    if (!e || !e.requirejs) {
                        ...
                        !function (e) {
                            ...
                            function s(t, e) {
                                var i, n, o, s, r, a, l, c, u, d, h, p = e && e.split("/"), f = y.map,
                                    g = f && f["*"] || {};
                                if (t && "." === t.charAt(0)) if (e) {
                                    for (p = p.slice(0, p.length - 1), t = t.split("/"), r = t.length - 1, y.nodeIdCompat && k.test(t[r]) && (t[r] = t[r].replace(k, "")), t = p.concat(t), u = 0; u < t.length; u += 1) if (h = t[u], "." === h) t.splice(u, 1), u -= 1; else if (".." === h) {
                                ...
                                if ((p || g) && f) {
                                    for (i = t.split("/"), u = i.length; u > 0; u -= 1) {
                                        if (n = i.slice(0, u).join("/"), p) for (d = p.length; d > 0; d -= 1) if (o = f[p.slice(0, d).join("/")], o && (o = o[n])) {
                                            s = o, a = u;
                                            break
                                        }
                                        if (s) break;
                            ...
                            function r(t, i) {
                                return function () {
                                    return p.apply(e, w.call(arguments, 0).concat([t, i]))
                                }
                            }
                            ...
                            var h, p, f, g, m = {}, v = {}, y = {}, b = {}, _ = Object.prototype.hasOwnProperty,
                                w = [].slice, k = /\.js$/;
                            f = function (t, e) {
                                var i, n = u(t), o = n[0];
                                return t = n[1], o && (o = s(o, e), i = c(o)), o ? t = i && i.normalize ? i.normalize(t, a(e)) : s(t, e) : (t = s(t, e), n = u(t), o = n[0], t = n[1], o && (i = c(o))), {
                                    f: o ? o + "!" + t : t,
                                    n: t,
                                    pr: o,
                                    p: i
                                ...
                                var a, u, d, h, p, y, _ = [], w = typeof n;
                                if (s = s || t, "undefined" === w || "function" === w) {
                                    for (i = !i.length && n.length ? ["require", "exports", "module"] : i, p = 0; p < i.length; p += 1) if (h = f(i[p], s), u = h.f, "require" === u) _[p] = g.require(t); else if ("exports" === u) _[p] = g.exports(t), y = !0; else if ("module" === u) a = _[p] = g.module(t); else if (o(m, u) || o(v, u) || o(b, u)) _[p] = c(u); else {
                                        if (!h.p) throw new Error(t + " missing " + u);
                                        h.p.load(h.n, r(s, !0), l(u), {}), _[p] = m[u]
                                    }
                                    d = n ? n.apply(m[t], _) : void 0, t && (a && a.exports !== e && a.exports !== m[t] ? m[t] = a.exports : d === e && y || (m[t] = d))
                                } else t && (m[t] = n)
                                ...
                                return i = i || function () {
                                }, "function" == typeof n && (n = o, o = s), o ? h(e, t, i, n) : setTimeout(function () {
                                    h(e, t, i, n)
                                }, 4), p
                            }, p.config = function (t) {
                                return p(t)
                    ...
                    return e.Extend(i, e.Observable), i.prototype.render = function () {
                        ...
                        n.append(i(o(e.args))), this.$results.append(n)
                        ...
                        this.$results.attr("id", o), e.on("results:all", function (t) {
                            ...
                            if (0 !== i) {
                                ...
                                var r = n.$results.offset().top, a = s.offset().top,
                                    l = n.$results.scrollTop() + (a - r);
                                0 === o ? n.$results.scrollTop(0) : a - r < 0 && n.$results.scrollTop(l)
                            }
                        ...
                        if (0 !== t.length) {
                            var e = this.$results.find("[aria-selected]"), i = e.index(t),
                                n = this.$results.offset().top, o = t.offset().top,
                                s = this.$results.scrollTop() + (o - n), r = o - n;
                            s -= 2 * t.outerHeight(!1), i <= 2 ? this.$results.scrollTop(0) : (r > this.$results.outerHeight() || r < 0) && this.$results.scrollTop(s)
                        }
                    }, i.prototype.template = function (e, i) {
                        var n = this.options.get("templateResult"), o = this.options.get("escapeMarkup"), s = n(e);
                    ...
                    return i.Extend(o, e), o.prototype.render = function () {
                        ...
                        var e = this.options.get("templateSelection"), i = this.options.get("escapeMarkup");
                        return i(e(t))
                    }, o.prototype.selectionContainer = function () {
                        return t("<span></span>")
                    }, o.prototype.update = function (t) {
                        if (0 === t.length) return void this.clear();
                        var e = t[0], i = this.display(e), n = this.$selection.find(".select2-selection__rendered");
                    ...
                    return i.Extend(n, e), n.prototype.render = function () {
                        ...
                        if (this.clear(), 0 !== t.length) {
                            for (var e = [], n = 0; n < t.length; n++) {
                                var o = t[n], s = this.display(o), r = this.selectionContainer();
                    ...
                    return e.prototype.bind = function (e, i, n) {
                        ...
                        e.call(this, i, n), i.on("*", function (e, i) {
                            if (t.inArray(e, s) !== -1) {
                                ...
                                o.$element.trigger(n), t.inArray(e, r) !== -1 && (i.prevented = n.isDefaultPrevented())
                            }
                        })
                    }, e
                    ...
                    return e.Extend(n, t), n.prototype.current = function (t) {
                        ...
                        if (this.$element.prop("multiple")) return t.selected = !1, i(t.element).is("option") ? (t.element.selected = !1, void this.$element.trigger("change")) : void this.current(function (n) {
                            for (var o = [], s = 0; s < n.length; s++) {
                                var r = n[s].id;
                                r !== t.id && i.inArray(r, o) === -1 && o.push(r)
                            }
                            e.$element.val(o), e.$element.trigger("change")
                        })
                    }, n.prototype.bind = function (t, e) {
                    ...
                    return e.Extend(n, t), n.prototype.select = function (t) {
                        ...
                        for (var o = this, s = this.$element.find("option"), r = s.map(function () {
                            ...
                            if (i.inArray(c.id, r) >= 0) {
                                var u = s.filter(n(c)), d = this.item(u), h = (i.extend(!0, {}, d, c), this.option(d));
                                u.replaceWith(h)
                            } else {
                                var p = this.option(c);
                                if (c.children) {
                    ...
                    function n(e, i) {
                        this.ajaxOptions = this._applyDefaults(i.get("ajax")), null != this.ajaxOptions.processResults && (this.processResults = this.ajaxOptions.processResults), t.__super__.constructor.call(this, e, i)
                    }
                    ...
                    return e.Extend(n, t), n.prototype._applyDefaults = function (t) {
                        ...
                        "function" == typeof s.url && (s.url = s.url(t)), "function" == typeof s.data && (s.data = s.data(t)), this.ajaxOptions.delay && "" !== t.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(n, this.ajaxOptions.delay)) : n()
                    }, n
                }), e.define("select2/data/tags", ["jquery"], function (t) {
                    function e(e, i, n) {
                        var o = n.get("tags"), s = n.get("createTag");
                        if (void 0 !== s && (this.createTag = s), e.call(this, i, n), t.isArray(o)) for (var r = 0; r < o.length; r++) {
                            var a = o[r], l = this._normalizeItem(a), c = this.option(l);
                        ...
                        function n(t, s) {
                            for (var r = t.results, a = 0; a < r.length; a++) {
                                var l = r[a], c = null != l.children && !n({results: l.children}, !0),
                                    u = l.text === e.term;
                                if (u || c) return !s && (t.data = r, void i(t))
                            }
                            if (s) return !0;
                            var d = o.createTag(e);
                            if (null != d) {
                                var h = o.option(d);
                                h.attr("data-select2-tag", !0), o.addOptions([h]), o.insertTag(r, d)
                            }
                            t.results = r, i(t)
                        }
                    ...
                    return e.prototype.bind = function (t, e, i) {
                        ...
                        var o = this;
                        e.term = e.term || "";
                        var s = this.tokenizer(e, this.options, n);
                        s.term !== e.term && (this.$search.length && (this.$search.val(s.term), this.$search.focus()), e.term = s.term), t.call(this, e, i)
                        ...
                        for (var s = n.get("tokenSeparators") || [], r = i.term, a = 0, l = this.createTag || function (t) {
                            ...
                            var c = r[a];
                            if (t.inArray(c, s) !== -1) {
                                var u = r.substr(0, a), d = t.extend({}, i, {term: u}), h = l(d);
                    ...
                    return i.prototype.bind = function (t, e, i) {
                        ...
                        var n = this, o = "scroll.select2." + i.id, s = "resize.select2." + i.id,
                            r = "orientationchange.select2." + i.id, a = this.$container.parents().filter(e.hasScroll);
                        a.each(function () {
                        ...
                        }), t(window).on(o + " " + s + " " + r, function (t) {
                            n._positionDropdown(), n._resizeDropdown()
                        })
                    }, i.prototype._detachPositioningHandler = function (i) {
                        var n = "scroll.select2." + i.id, o = "resize.select2." + i.id,
                            s = "orientationchange.select2." + i.id, r = this.$container.parents().filter(e.hasScroll);
                        r.off(n), t(window).off(n + " " + o + " " + s)
                    }, i.prototype._positionDropdown = function () {
                        var e = t(window), i = this.$dropdown.hasClass("select2-dropdown--above"),
                            n = this.$dropdown.hasClass("select2-dropdown--below"), o = null,
                            s = (this.$container.position(), this.$container.offset());
                        s.bottom = s.top + this.$container.outerHeight(!1);
                        var r = {height: this.$container.outerHeight(!1)};
                        r.top = s.top, r.bottom = s.top + r.height;
                    ...
                    P.prototype.apply = function (d) {
                        if (d = t.extend({}, this.defaults, d), null == d.dataAdapter) {
                            if (null != d.ajax ? d.dataAdapter = f : null != d.data ? d.dataAdapter = p : d.dataAdapter = h, d.minimumInputLength > 0 && (d.dataAdapter = c.Decorate(d.dataAdapter, v)), d.maximumInputLength > 0 && (d.dataAdapter = c.Decorate(d.dataAdapter, y)), d.maximumSelectionLength > 0 && (d.dataAdapter = c.Decorate(d.dataAdapter, b)), d.tags && (d.dataAdapter = c.Decorate(d.dataAdapter, g)), null == d.tokenSeparators && null == d.tokenizer || (d.dataAdapter = c.Decorate(d.dataAdapter, m)), null != d.query) {
                                var I = e(d.amdBase + "compat/query");
                        ...
                        if (null == d.resultsAdapter && (d.resultsAdapter = i, null != d.ajax && (d.resultsAdapter = c.Decorate(d.resultsAdapter, x)), null != d.placeholder && (d.resultsAdapter = c.Decorate(d.resultsAdapter, k)), d.selectOnClose && (d.resultsAdapter = c.Decorate(d.resultsAdapter, T))), null == d.dropdownAdapter) {
                            if (d.multiple) d.dropdownAdapter = _; else {
                                var j = c.Decorate(_, w);
                                d.dropdownAdapter = j
                            }
                            if (0 !== d.minimumResultsForSearch && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, D)), d.closeOnSelect && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, S)), null != d.dropdownCssClass || null != d.dropdownCss || null != d.adaptDropdownCssClass) {
                        ...
                        if ("string" == typeof d.language) if (d.language.indexOf("-") > 0) {
                            var $ = d.language.split("-"), E = $[0];
                            d.language = [d.language, E]
                        } else d.language = [d.language];
                        if (t.isArray(d.language)) {
                            var M = new u;
                            d.language.push("en");
                            for (var H = d.language, L = 0; L < H.length; L++) {
                                var z = H[L], O = {};
                                try {
                                    O = u.loadPath(z)
                                } catch (q) {
                                    try {
                                        z = this.defaults.amdLanguageBase + z, O = u.loadPath(z)
                                    } catch (R) {
                            ...
                            var W = u.loadPath(this.defaults.amdLanguageBase + "en"), F = new u(d.language);
                            F.extend(W), d.translations = F
                        }
                        return d
                        ...
                        function i(n, o) {
                            ...
                            var c = e(o.text).toUpperCase(), u = e(n.term).toUpperCase();
                    ...
                    var o = function (t, i) {
                        ...
                        var u = this;
                        this._bindAdapters(), this._registerDomEvents(), this._registerDataEvents(), this._registerSelectionEvents(), this._registerDropdownEvents(), this._registerResultsEvents(), this._registerEvents(),
                    ...
                    return i.Extend(o, i.Observable), o.prototype._generateId = function (t) {
                        ...
                        if ("style" == e) {
                            ...
                            for (var r = s.split(";"), a = 0, l = r.length; a < l; a += 1) {
                                var c = r[a].replace(/\s/g, ""), u = c.match(i);
                        ...
                        this.on("open", function () {
                            ...
                            var i = e.which;
                            t.isOpen() ? i === n.ENTER ? (t.trigger("results:select"), e.preventDefault()) : i === n.SPACE && e.ctrlKey ? (t.trigger("results:toggle"), e.preventDefault()) : i === n.UP ? (t.trigger("results:previous"), e.preventDefault()) : i === n.DOWN ? (t.trigger("results:next"), e.preventDefault()) : i !== n.ESC && i !== n.TAB || (t.close(), e.preventDefault()) : (i === n.ENTER || i === n.SPACE || (i === n.DOWN || i === n.UP) && e.altKey) && (t.open(), e.preventDefault())
                        })
                    ...
                    if (e("jquery.mousewheel"), null == t.fn.select2) {
                        ...
                        t.fn.select2 = function (e) {
                            ...
                            if ("string" == typeof e) {
                                ...
                                var s = Array.prototype.slice.call(arguments, 1), r = n[e](s);
                                return t.inArray(e, o) > -1 ? this : r
                            }
    ...
    }, {jquery: 69, "jquery.mousewheel": 68}],
        ...
        !function ($) {
            function Timepicker() {
                this.debug = !0, this._curInst = null, this._disabledInputs = [], this._timepickerShowing = !1, this._inDialog = !1, this._dialogClass = "ui-timepicker-dialog", this._mainDivId = "ui-timepicker-div", this._inlineClass = "ui-timepicker-inline", this._currentClass = "ui-timepicker-current", this._dayOverClass = "ui-timepicker-days-cell-over", this.regional = [], this.regional[""] = {
                    ...
                    maxTime: {hour: null, minute: null},
                    minTime: {hour: null, minute: null}
            ...
            $.extend(Timepicker.prototype, {
                markerClassName: "hasTimepicker", log: function () {
                    ...
                    if ("focus" != o && "both" != o || (t.bind("focus.timepicker", this._showTimepicker), t.bind("click.timepicker", this._adjustZIndex)), "button" == o || "both" == o) {
                        var s = this._get(e, "button");
                        null == s && (s = $('<button class="ui-timepicker-trigger" type="button">...</button>'), t.after(s)), $(s).bind("click.timepicker", function () {
                    ...
                    if (t = t.target || t, "input" != t.nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.timepicker._isDisabledTimepicker(t) && $.timepicker._lastInput != t) {
                        ...
                        var o = {left: $.timepicker._pos[0], top: $.timepicker._pos[1]};
                        if ($.timepicker._pos = null, e.tpDiv.css({
                            ...
                            var o = e.tpDiv.offset();
                            $.timepicker._pos = [o.top, o.left]
                        }
                        if (e._hoursClicked = !1, e._minutesClicked = !1, o = $.timepicker._checkOffset(e, o, n), e.tpDiv.css({
                            position: $.timepicker._inDialog && $.blockUI ? "static" : n ? "fixed" : "absolute",
                            display: "none",
                            left: o.left + "px",
                            top: o.top + "px"
                        }), !e.inline) {
                            var s = $.timepicker._get(e, "showAnim"), r = $.timepicker._get(e, "duration"),
                                a = function () {
                            ...
                            $.timepicker._adjustZIndex(t), $.effects && $.effects[s] ? e.tpDiv.show(s, $.timepicker._get(e, "showOptions"), r, a) : e.tpDiv.show(s ? r : null, a), s && r || a(), e.input.is(":visible") && !e.input.is(":disabled") && e.input.focus(), $.timepicker._curInst = e
                        }
                    }
                }, _getZIndex: function (t) {
                    for (var e, i, n = $(t), o = 0; n.length && n[0] !== document;) e = n.css("position"), "absolute" !== e && "relative" !== e && "fixed" !== e || (i = parseInt(n.css("zIndex"), 10), isNaN(i) || 0 === i || i > o && (o = i)), n = n.parent();
                    return o
                    ...
                    t.tpDiv.find("iframe.ui-timepicker-cover").css({
                        ...
                        i._isDisabledTimepicker(t.inline ? t.tpDiv.parent()[0] : t.input[0]) || ($(this).parents(".ui-timepicker-calendar").find("a").removeClass("ui-state-hover"), $(this).addClass("ui-state-hover"), this.className.indexOf("ui-timepicker-prev") != -1 && $(this).addClass("ui-timepicker-prev-hover"), this.className.indexOf("ui-timepicker-next") != -1 && $(this).addClass("ui-timepicker-next-hover"))
                    ...
                    }).end().find(".ui-timepicker-close").bind("click", function (t) {
                        $.timepicker._hideTimepicker()
                    }).end()
                }, _generateHTML: function (t) {
                    var e, i, n, o, s = 1 == this._get(t, "showPeriod"), r = 1 == this._get(t, "showPeriodLabels"),
                        a = 1 == this._get(t, "showLeadingZero"), l = 1 == this._get(t, "showHours"),
                        c = 1 == this._get(t, "showMinutes"), u = this._get(t, "amPmText"), d = this._get(t, "rows"),
                        h = 0, p = 0, f = 0, g = 0, m = 0, v = 0, y = Array(), b = this._get(t, "hours"), _ = null,
                        w = 0, k = this._get(t, "hourText"), x = this._get(t, "showCloseButton"),
                        C = this._get(t, "closeButtonText"), D = this._get(t, "showNowButton"),
                        T = this._get(t, "nowButtonText"), S = this._get(t, "showDeselectButton"),
                        I = this._get(t, "deselectButtonText"), P = x || D || S;
                    for (e = b.starts; e <= b.ends; e++) y.push(e);
                    if (_ = Math.ceil(y.length / d), r) {
                        for (w = 0; w < y.length; w++) y[w] < 12 ? f++ : g++;
                        w = 0, h = Math.floor(f / y.length * d), p = Math.floor(g / y.length * d), d != h + p && (f && (!g || !h || p && f / h >= g / p) ? h++ : p++), m = Math.min(h, 1), v = h + 1, _ = 0 == h ? Math.ceil(g / p) : 0 == p ? Math.ceil(f / h) : Math.ceil(Math.max(f / h, g / p))
                    }
                    if (o = '<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>', l) {
                        for (o += '<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">' + k + '</div><table class="ui-timepicker">', i = 1; i <= d; i++) {
                            for (o += "<tr>", i == m && r && (o += '<th rowspan="' + h.toString() + '" class="periods" scope="row">' + u[0] + "</th>"), i == v && r && (o += '<th rowspan="' + p.toString() + '" class="periods" scope="row">' + u[1] + "</th>"), n = 1; n <= _; n++) r && i < v && y[w] >= 12 ? o += this._generateHTMLHourCell(t, void 0, s, a) : (o += this._generateHTMLHourCell(t, y[w], s, a), w++);
                            o += "</tr>"
                        }
                        o += "</table></td>"
                    }
                    if (c && (o += '<td class="ui-timepicker-minutes">', o += this._generateHTMLMinutes(t), o += "</td>"), o += "</tr>", P) {
                        var j = '<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">';
                        D && (j += '<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#' + t.id.replace(/\\\\/g, "\\") + '" >' + T + "</button>"), S && (j += '<button type="button" class="ui-timepicker-deselect ui-state-default ui-corner-all"  data-timepicker-instance-id="#' + t.id.replace(/\\\\/g, "\\") + '" >' + I + "</button>"), x && (j += '<button type="button" class="ui-timepicker-close ui-state-default ui-corner-all"  data-timepicker-instance-id="#' + t.id.replace(/\\\\/g, "\\") + '" >' + C + "</button>"), o += j + "</div></td></tr>"
                    }
                    return o += "</table>"
                    ...
                    var e, n, o = "", s = this._get(t, "rows"), r = Array(), a = this._get(t, "minutes"), l = null,
                        c = 0, u = 1 == this._get(t, "showMinutesLeadingZero"), d = this._get(t, "onMinuteShow"),
                        h = this._get(t, "minuteText");
                    for (a.starts || (a.starts = 0), a.ends || (a.ends = 59), a.manual || (a.manual = []), e = a.starts; e <= a.ends; e += a.interval) r.push(e);
                    for (i = 0; i < a.manual.length; i++) {
                        var p = a.manual[i];
                        "number" != typeof p || p < 0 || p > 59 || $.inArray(p, r) >= 0 || r.push(p)
                    }
                    if (r.sort(function (t, e) {
                        return t - e
                    }), l = Math.round(r.length / s + .49), d && 0 == d.apply(t.input ? t.input[0] : null, [t.hours, t.minutes])) for (c = 0; c < r.length; c += 1) if (e = r[c], d.apply(t.input ? t.input[0] : null, [t.hours, e])) {
                        t.minutes = e;
                        break
                    }
                    for (o += '<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">' + h + '</div><table class="ui-timepicker">', c = 0, n = 1; n <= s; n++) {
                        for (o += "<tr>"; c < n * l;) {
                            var e = r[c], f = "";
                            void 0 !== e && (f = e < 10 && u ? "0" + e.toString() : e.toString()), o += this._generateHTMLMinuteCell(t, e, f), c++
                        }
                        o += "</tr>"
                    }
                    return o += "</table>"
                    ...
                    var o = e;
                    e > 12 && i && (o = e - 12), 0 == o && i && (o = 12), o < 10 && n && (o = "0" + o);
                    var s = "", r = !0, a = this._get(t, "onHourShow"), l = this._get(t, "maxTime"),
                        c = this._get(t, "minTime");
                    return void 0 == e ? s = '<td><span class="ui-state-default ui-state-disabled">&nbsp;</span></td>' : (a && (r = a.apply(t.input ? t.input[0] : null, [e])), r && (!isNaN(parseInt(l.hour)) && e > l.hour && (r = !1), !isNaN(parseInt(c.hour)) && e < c.hour && (r = !1)), s = r ? '<td class="ui-timepicker-hour-cell" data-timepicker-instance-id="#' + t.id.replace(/\\\\/g, "\\") + '" data-hour="' + e.toString() + '"><a class="ui-state-default ' + (e == t.hours ? "ui-state-active" : "") + '">' + o.toString() + "</a></td>" : '<td><span class="ui-state-default ui-state-disabled ' + (e == t.hours ? " ui-state-active " : " ") + '">' + o.toString() + "</span></td>")
                }, _generateHTMLMinuteCell: function (t, e, i) {
                    var n = "", o = !0, s = t.hours, r = this._get(t, "onMinuteShow"), a = this._get(t, "maxTime"),
                        l = this._get(t, "minTime");
                    return r && (o = r.apply(t.input ? t.input[0] : null, [t.hours, e])), void 0 == e ? n = '<td><span class="ui-state-default ui-state-disabled">&nbsp;</span></td>' : (o && null !== s && (!isNaN(parseInt(a.hour)) && !isNaN(parseInt(a.minute)) && s >= a.hour && e > a.minute && (o = !1), !isNaN(parseInt(l.hour)) && !isNaN(parseInt(l.minute)) && s <= l.hour && e < l.minute && (o = !1)), n = o ? '<td class="ui-timepicker-minute-cell" data-timepicker-instance-id="#' + t.id.replace(/\\\\/g, "\\") + '" data-minute="' + e.toString() + '" ><a class="ui-state-default ' + (e == t.minutes ? "ui-state-active" : "") + '" >' + i + "</a></td>" : '<td><span class="ui-state-default ui-state-disabled" >' + i + "</span></td>")
                    ...
                    if (e.hasClass(this.markerClassName)) {
                        ...
                        if ("input" == o) {
                            ...
                            r.children().removeClass("ui-state-disabled"), r.find("button").each(function () {
                                this.disabled = !1
                            })
                        }
                    ...
                    if (e.hasClass(this.markerClassName)) {
                        var n = t.nodeName.toLowerCase();
                        if ("input" == n) {
                            var o = this._get(i, "button");
                            $(o).addClass("ui-state-disabled").disabled = !0, t.disabled = !0, i.trigger.filter("button").each(function () {
                                this.disabled = !0
                            }).end()
                    ...
                    var n = t.tpDiv.outerWidth(), o = t.tpDiv.outerHeight(), s = t.input ? t.input.outerWidth() : 0,
                    ...
                    return e.left -= this._get(t, "isRTL") ? n - s : 0, e.left -= i && e.left == t.input.offset().left ? $(document).scrollLeft() : 0, e.top -= i && e.top == t.input.offset().top + r ? $(document).scrollTop() : 0, e.left -= Math.min(e.left, e.left + n > a && a > n ? Math.abs(e.left + n - a) : 0), e.top -= Math.min(e.top, e.top + o > l && l > o ? Math.abs(o + r) : 0), e
                }, _findPos: function (t) {
                    ...
                    if (e && (!t || e == $.data(t, PROP_NAME)) && this._timepickerShowing) {
                        ...
                        $.effects && $.effects[i] ? e.tpDiv.hide(i, $.timepicker._get(e, "showOptions"), n, o) : e.tpDiv["slideDown" == i ? "slideUp" : "fadeIn" == i ? "fadeOut" : "hide"](i ? n : null, o), i || o(), this._timepickerShowing = !1, this._lastInput = null, this._inDialog && (this._dialogInput.css({
                            position: "absolute",
                            left: "0",
                            top: "-100px"
                    ...
                    if (t.input.val() != t.lastVal) {
                        ...
                        if (0 == t.inline && "" != t.input.val() && (i = t.input.val()), i instanceof Date) t.hours = i.getHours(), t.minutes = i.getMinutes(); else {
                            ...
                            if ("" == i) t.hours = -1, t.minutes = -1; else {
                                var o = this.parseTime(t, n);
                                t.hours = o.hours, t.minutes = o.minutes
                            }
                        }
                    ...
                    var o = e || {};
                    "string" == typeof e && (o = {}, o[e] = i), n && (extendRemove(n.settings, o), this._curInst == n && (this._hideTimepicker(), this._updateTimepicker(n)), n.inline && this._updateTimepicker(n))
                    ...
                    n == t.hours && o == t.minutes || i || t.input.trigger("change"), this._updateTimepicker(t), this._updateSelectedValue(t)
                }, _getCurrentTimeRounded: function (t) {
                    var e = new Date, i = e.getMinutes(), n = this._get(t, "minutes"),
                        o = Math.round(i / n.interval) * n.interval;
                    return e.setMinutes(o), e
                }, parseTime: function (t, e) {
                    var i = new Object;
                    if (i.hours = -1, i.minutes = -1, !e) return "";
                    var n = this._get(t, "timeSeparator"), o = this._get(t, "amPmText"), s = this._get(t, "showHours"),
                        r = this._get(t, "showMinutes"), a = this._get(t, "optionalMinutes"),
                        l = 1 == this._get(t, "showPeriod"), c = e.indexOf(n);
                    if (c != -1 ? (i.hours = parseInt(e.substr(0, c), 10), i.minutes = parseInt(e.substr(c + 1), 10)) : !s || r && !a ? !s && r && (i.minutes = parseInt(e, 10)) : i.hours = parseInt(e, 10), s) {
                        var u = e.toUpperCase();
                        i.hours < 12 && l && u.indexOf(o[1].toUpperCase()) != -1 && (i.hours += 12), 12 == i.hours && l && u.indexOf(o[0].toUpperCase()) != -1 && (i.hours = 0)
                    }
                    return i
                }, selectNow: function (t) {
                    var e = $(t.target).attr("data-timepicker-instance-id"), i = $(e), n = this._getInst(i[0]),
                        o = new Date;
                    n.hours = o.getHours(), n.minutes = o.getMinutes(), this._updateSelectedValue(n), this._updateTimepicker(n), this._hideTimepicker()
                }, deselectTime: function (t) {
                    var e = $(t.target).attr("data-timepicker-instance-id"), i = $(e), n = this._getInst(i[0]);
                    n.hours = -1, n.minutes = -1, this._updateSelectedValue(n), this._hideTimepicker()
                }, selectHours: function (t) {
                    var e = $(t.currentTarget), i = e.attr("data-timepicker-instance-id"),
                        n = parseInt(e.attr("data-hour")), o = t.data.fromDoubleClick, s = $(i),
                        r = this._getInst(s[0]), a = 1 == this._get(r, "showMinutes");
                    if ($.timepicker._isDisabledTimepicker(s.attr("id"))) return !1;
                    e.parents(".ui-timepicker-hours:first").find("a").removeClass("ui-state-active"), e.children("a").addClass("ui-state-active"), r.hours = n;
                    var l = this._get(r, "onMinuteShow"), c = this._get(r, "maxTime"), u = this._get(r, "minTime");
                    return !l && isNaN(parseInt(c.minute)) && isNaN(parseInt(u.minute)) || this._updateMinuteDisplay(r), this._updateSelectedValue(r), r._hoursClicked = !0, (r._minutesClicked || o || 0 == a) && $.timepicker._hideTimepicker(), !1
                }, selectMinutes: function (t) {
                    var e = $(t.currentTarget), i = e.attr("data-timepicker-instance-id"),
                        n = parseInt(e.attr("data-minute")), o = t.data.fromDoubleClick, s = $(i),
                        r = this._getInst(s[0]), a = 1 == this._get(r, "showHours");
                    return !$.timepicker._isDisabledTimepicker(s.attr("id")) && (e.parents(".ui-timepicker-minutes:first").find("a").removeClass("ui-state-active"), e.children("a").addClass("ui-state-active"), r.minutes = n, this._updateSelectedValue(r), r._minutesClicked = !0, !(!r._hoursClicked && !o && 0 != a) && ($.timepicker._hideTimepicker(), !1))
                    ...
                    if (t.hours == -1 && t.minutes == -1) return "";
                    (t.hours < t.hours.starts || t.hours > t.hours.ends) && (t.hours = 0), (t.minutes < t.minutes.starts || t.minutes > t.minutes.ends) && (t.minutes = 0);
                    var e = "", i = 1 == this._get(t, "showPeriod"), n = 1 == this._get(t, "showLeadingZero"),
                        o = 1 == this._get(t, "showHours"), s = 1 == this._get(t, "showMinutes"),
                        r = 1 == this._get(t, "optionalMinutes"), a = this._get(t, "amPmText"),
                        l = t.hours ? t.hours : 0, c = t.minutes ? t.minutes : 0, u = l ? l : 0, d = "";
                    u == -1 && (u = 0), c == -1 && (c = 0), i && (0 == t.hours && (u = 12), t.hours < 12 ? e = a[0] : (e = a[1], u > 12 && (u -= 12)));
                    var h = u.toString();
                    n && u < 10 && (h = "0" + h);
                    var p = c.toString();
                    return c < 10 && (p = "0" + p), o && (d += h), !o || !s || r && 0 == p || (d += this._get(t, "timeSeparator")), !s || r && 0 == p || (d += p), o && e.length > 0 && (d += this._get(t, "periodSeparator") + e), d
                    ...
                    var e = this._getInst(t);
                    return e.hours == -1 && e.minutes == -1 ? "" : ((e.hours < e.hours.starts || e.hours > e.hours.ends) && (e.hours = 0), (e.minutes < e.minutes.starts || e.minutes > e.minutes.ends) && (e.minutes = 0), new Date(0, 0, 0, e.hours, e.minutes, 0))
